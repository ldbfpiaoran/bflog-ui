...
var init_tokenizationRegistry = __esm({
  "node_modules/monaco-editor/esm/vs/editor/common/tokenizationRegistry.js"() {
    ...
    TokenizationRegistry = class {
      ...
      register(language2, support) {
        this._map.set(language2, support);
        this.fire([language2]);
        return toDisposable(() => {
          if (this._map.get(language2) !== support) {
            return;
          }
          this._map.delete(language2);
          this.fire([language2]);
        });
      }
      ...
      get(language2) {
        return this._map.get(language2) || null;
      }
...
//# sourceMappingURL=chunk-RCCMGOTV.js.map
