  ...
  var CSSMotionList = function(_React$Component) {
    ...
    _createClass(CSSMotionList2, [{
      ...
      value: function render() {
        ...
        var Component5 = component || React17.Fragment;
        var motionProps = {};
        ...
        return React17.createElement(Component5, restProps, keyEntities.map(function(_ref2, index2) {
...
// node_modules/rc-menu/es/context/MenuContext.js
var _excluded3 = ["children", "locked"];
...
function InheritableContextProvider(_ref) {
  var children = _ref.children, locked = _ref.locked, restProps = _objectWithoutProperties(_ref, _excluded3);
  var context = React18.useContext(MenuContext);
  var inheritableContext = useMemo(function() {
    return mergeProps(context, restProps);
  }, [context, restProps], function(prev, next) {
    return !locked && (prev[0] !== next[0] || !isEqual_default(prev[1], next[1], true));
  });
  return React18.createElement(MenuContext.Provider, {
...
var EmptyList = [];
var PathRegisterContext = React19.createContext(null);
function useMeasure() {
  return React19.useContext(PathRegisterContext);
}
var PathTrackerContext = React19.createContext(EmptyList);
function useFullPath(eventKey) {
  var parentKeyPath = React19.useContext(PathTrackerContext);
  return React19.useMemo(function() {
    return eventKey !== void 0 ? [].concat(_toConsumableArray(parentKeyPath), [eventKey]) : parentKeyPath;
  }, [parentKeyPath, eventKey]);
}
var PathUserContext = React19.createContext(null);
...
function parseChildren(children, keyPath) {
  return toArray(children).map(function(child, index2) {
    if (React20.isValidElement(child)) {
      ...
      return React20.cloneElement(child, cloneProps);
    }
    return child;
  });
}
...
// node_modules/rc-menu/es/MenuItemGroup.js
var _excluded4 = ["className", "title", "eventKey", "children"];
var _excluded23 = ["children"];
var InternalMenuItemGroup = function InternalMenuItemGroup2(_ref) {
  var className = _ref.className, title = _ref.title, eventKey = _ref.eventKey, children = _ref.children, restProps = _objectWithoutProperties(_ref, _excluded4);
  var _React$useContext = React21.useContext(MenuContext), prefixCls = _React$useContext.prefixCls;
  var groupPrefixCls = "".concat(prefixCls, "-item-group");
  return React21.createElement("li", _extends({
    role: "presentation"
  }, restProps, {
    onClick: function onClick(e) {
      return e.stopPropagation();
    },
    className: (0, import_classnames2.default)(groupPrefixCls, className)
  }), React21.createElement("div", {
    role: "presentation",
    className: "".concat(groupPrefixCls, "-title"),
    title: typeof title === "string" ? title : void 0
  }, title), React21.createElement("ul", {
    role: "group",
    className: "".concat(groupPrefixCls, "-list")
  }, children));
};
function MenuItemGroup(_ref2) {
  var children = _ref2.children, props = _objectWithoutProperties(_ref2, _excluded23);
  ...
  return React21.createElement(InternalMenuItemGroup, omit(props, ["warnKey"]), childList);
}
...
function Divider(_ref) {
  ...
  return React22.createElement("li", {
    role: "separator",
    className: (0, import_classnames3.default)("".concat(prefixCls, "-item-divider"), className),
    style: style2
  });
}
...
function InternalItem(props, ref) {
  ...
  var itemNode = React23.createElement(Component5, _extends({
  ...
  if (responsive) {
    itemNode = React23.createElement(es_default2, {
...
var Item = React23.forwardRef(InternalItem);
...
// node_modules/rc-overflow/es/hooks/useEffectState.js
function useBatcher() {
  var updateFuncRef = React24.useRef(null);
...
function useEffectState(notifyEffectUpdate, defaultValue) {
  var _React$useState = React24.useState(defaultValue), _React$useState2 = _slicedToArray(_React$useState, 2), stateValue = _React$useState2[0], setStateValue = _React$useState2[1];
...
var OverflowContext = import_react7.default.createContext(null);
...
var InternalRawItem = function InternalRawItem2(props, ref) {
  var context = React26.useContext(OverflowContext);
  if (!context) {
    var _props$component = props.component, Component5 = _props$component === void 0 ? "div" : _props$component, _restProps = _objectWithoutProperties(props, _excluded6);
    return React26.createElement(Component5, _extends({}, _restProps, {
      ref
    }));
  }
  ...
  return React26.createElement(OverflowContext.Provider, {
    value: null
  }, React26.createElement(Item_default, _extends({
    ref,
    className: (0, import_classnames5.default)(contextClassName, className)
  }, restContext, restProps)));
};
var RawItem = React26.forwardRef(InternalRawItem);
...
function Overflow(props, ref) {
  ...
  var mergedDisplayCount = React27.useMemo(function() {
  ...
  var getKey = (0, import_react8.useCallback)(function(item, index2) {
    var _ref;
  ...
  var internalRenderItemNode = renderRawItem ? function(item, index2) {
    ...
    return React27.createElement(OverflowContext.Provider, {
      key,
    ...
    var key = getKey(item, index2);
    return React27.createElement(Item_default, _extends({}, itemSharedProps, {
      order: index2,
      key,
      item,
  ...
  if (!renderRawRest) {
    ...
    restNode = React27.createElement(Item_default, _extends({}, itemSharedProps, restContextProps), typeof mergedRenderRest === "function" ? mergedRenderRest(omittedItems) : mergedRenderRest);
  } else if (renderRawRest) {
    restNode = React27.createElement(OverflowContext.Provider, {
      value: _objectSpread2(_objectSpread2({}, itemSharedProps), restContextProps)
    }, renderRawRest(omittedItems));
  }
  var overflowNode = React27.createElement(Component5, _extends({
    className: (0, import_classnames6.default)(!invalidate && prefixCls, className),
    style: style2,
    ref
  }, restProps), mergedData.map(internalRenderItemNode), showRest ? restNode : null, suffix && React27.createElement(Item_default, _extends({}, itemSharedProps, {
  ...
  if (isResponsive) {
    overflowNode = React27.createElement(es_default2, {
...
var ForwardOverflow = React27.forwardRef(Overflow);
...
var IdContext = React28.createContext(null);
...
function useMenuId(eventKey) {
  var id = React28.useContext(IdContext);
  return getMenuId(id, eventKey);
}

// node_modules/rc-menu/es/context/PrivateContext.js
var React29 = __toESM(require_react());
var PrivateContext = React29.createContext({});
...
function useAccessibility(mode, activeKey, isRtl, id, containerRef, getKeys, getKeyPath, triggerActiveKey, triggerAccessibilityOpen, originOnKeyDown) {
  var rafRef = React30.useRef();
  var activeRef = React30.useRef();
...
function useKeyRecords() {
  var _React$useState = React31.useState({}), _React$useState2 = _slicedToArray(_React$useState, 2), internalForceUpdate = _React$useState2[1];
  var key2pathRef = (0, import_react9.useRef)(/* @__PURE__ */ new Map());
  var path2keyRef = (0, import_react9.useRef)(/* @__PURE__ */ new Map());
  var _React$useState3 = React31.useState([]), _React$useState4 = _slicedToArray(_React$useState3, 2), overflowKeys = _React$useState4[0], setOverflowKeys = _React$useState4[1];
...
function useMemoCallback(func) {
  var funRef = React32.useRef(func);
  funRef.current = func;
  var callback = React32.useCallback(function() {
    var _funRef$current;
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
...
function useActive(eventKey, disabled, onMouseEnter, onMouseLeave) {
  var _React$useContext = React34.useContext(MenuContext), activeKey = _React$useContext.activeKey, onActive = _React$useContext.onActive, onInactive = _React$useContext.onInactive;
  var ret = {
...
function useDirectionStyle(level) {
  var _React$useContext = React35.useContext(MenuContext), mode = _React$useContext.mode, rtl = _React$useContext.rtl, inlineIndent = _React$useContext.inlineIndent;
  if (mode !== "inline") {
    return null;
  }
  var len = level;
...
function Icon(_ref) {
  ...
  if (typeof icon === "function") {
    iconNode = React36.createElement(icon, _objectSpread2({}, props));
...
var LegacyMenuItem = function(_React$Component) {
  ...
  _createClass(LegacyMenuItem2, [{
    ...
    value: function render() {
      ...
      return React37.createElement(es_default4.Item, _extends({}, attribute, {
        title: typeof title === "string" ? title : void 0
      }, passedProps, {
        ref: elementRef
      }));
...
var InternalMenuItem = React37.forwardRef(function(props, ref) {
  var _classNames;
  ...
  var _React$useContext = React37.useContext(MenuContext), prefixCls = _React$useContext.prefixCls, onItemClick = _React$useContext.onItemClick, contextDisabled = _React$useContext.disabled, overflowDisabled = _React$useContext.overflowDisabled, contextItemIcon = _React$useContext.itemIcon, selectedKeys = _React$useContext.selectedKeys, onActive = _React$useContext.onActive;
  var _React$useContext2 = React37.useContext(PrivateContext_default), _internalRenderMenuItem = _React$useContext2._internalRenderMenuItem;
  var itemCls = "".concat(prefixCls, "-item");
  var legacyMenuItemRef = React37.useRef();
  ...
  var renderNode = React37.createElement(LegacyMenuItem, _extends({
    ...
    className: (0, import_classnames7.default)(itemCls, (_classNames = {}, _defineProperty(_classNames, "".concat(itemCls, "-active"), active), _defineProperty(_classNames, "".concat(itemCls, "-selected"), selected), _defineProperty(_classNames, "".concat(itemCls, "-disabled"), mergedDisabled), _classNames), className),
    onClick: onInternalClick,
    onKeyDown: onInternalKeyDown,
    onFocus: onInternalFocus
  }), children, React37.createElement(Icon, {
...
function MenuItem(props, ref) {
  ...
  return React37.createElement(InternalMenuItem, _extends({}, props, {
    ref
  }));
}
var MenuItem_default = React37.forwardRef(MenuItem);
...
var InternalSubMenuList = function InternalSubMenuList2(_ref, ref) {
  ...
  var _React$useContext = React38.useContext(MenuContext), prefixCls = _React$useContext.prefixCls, mode = _React$useContext.mode, rtl = _React$useContext.rtl;
  return React38.createElement("ul", _extends({
    className: (0, import_classnames8.default)(prefixCls, rtl && "".concat(prefixCls, "-rtl"), "".concat(prefixCls, "-sub"), "".concat(prefixCls, "-").concat(mode === "inline" ? "inline" : "vertical"), className),
    role: "menu"
  }, restProps, {
    "data-menu-list": true,
    ref
...
var SubMenuList = React38.forwardRef(InternalSubMenuList);
...
function useDom(render, debug) {
  ...
  var queueCreate = React40.useContext(Context_default);
...
function Mask(props) {
  ...
  return React45.createElement(es_default3, _extends({}, motion, {
    motionAppear: true,
    visible: open,
    removeOnLeave: true
  }), function(_ref) {
...
var Popup = React47.forwardRef(function(props, ref) {
  ...
  return React47.createElement(Portal2, {
    ...
    mask,
    motion: maskMotion
  }), React47.createElement(es_default2, {
    onResize: onAlign,
    disabled: !open
  }, function(resizeObserverRef) {
    return React47.createElement(es_default3, _extends({
      motionAppear: true,
      motionEnter: true,
      motionLeave: true,
      removeOnLeave: false,
      ...
      var cls = (0, import_classnames11.default)(prefixCls, motionClassName, className);
...
function useWinClick(open, clickToHide, targetEle, popupEle, mask, maskClosable, inPopupOrChild, triggerOpen) {
  ...
  var lockRef = React52.useRef(false);
...
function generateTrigger() {
  ...
  var Trigger = React53.forwardRef(function(props, ref) {
    ...
    return React53.createElement(React53.Fragment, null, React53.createElement(es_default2, {
      disabled: !mergedOpen,
      ref: setTargetRef,
...
function PopupTrigger(_ref) {
  ...
  return React54.createElement(es_default6, {
    prefixCls,
    popupClassName: (0, import_classnames13.default)("".concat(prefixCls, "-popup"), _defineProperty({}, "".concat(prefixCls, "-rtl"), rtl), popupClassName, rootClassName),
...
function InlineSubMenuList(_ref) {
  ...
  }, React55.createElement(es_default3, _extends({
    visible: mergedOpen
  }, mergedMotion, {
    forceRender: forceSubMenuRender,
    removeOnLeave: false,
...
var InternalSubMenu = function InternalSubMenu2(props) {
  ...
  var listNode = React56.createElement(es_default4.Item, _extends({
    role: "none"
  }, restProps, {
    component: "li",
    style: style2,
    className: (0, import_classnames14.default)(subMenuPrefixCls, "".concat(subMenuPrefixCls, "-").concat(mode), className, (_classNames = {}, _defineProperty(_classNames, "".concat(subMenuPrefixCls, "-open"), open), _defineProperty(_classNames, "".concat(subMenuPrefixCls, "-active"), mergedActive), _defineProperty(_classNames, "".concat(subMenuPrefixCls, "-selected"), childrenSelected), _defineProperty(_classNames, "".concat(subMenuPrefixCls, "-disabled"), mergedDisabled), _classNames)),
...
function SubMenu(props) {
  ...
  if (measure) {
    ...
    renderNode = React56.createElement(InternalSubMenu, props, childList);
  }
  ...
  return (list || []).map(function(opt, index2) {
    if (opt && _typeof(opt) === "object") {
      ...
      if (children || type === "group") {
        if (type === "group") {
          return React57.createElement(MenuItemGroup, _extends({
            key: mergedKey
          }, restProps, {
            title: label
          }), convertItemsToNodes(children));
        }
        return React57.createElement(SubMenu, _extends({
          key: mergedKey
        }, restProps, {
          title: label
        }), convertItemsToNodes(children));
      ...
      if (type === "divider") {
        return React57.createElement(Divider, _extends({
          key: mergedKey
        }, restProps));
      }
      return React57.createElement(MenuItem_default, _extends({
        key: mergedKey
      }, restProps), label);
    }
    return null;
...
var Menu = React58.forwardRef(function(props, ref) {
  ...
  var _React$useState3 = React58.useState(mergedOpenKeys), _React$useState4 = _slicedToArray(_React$useState3, 2), inlineCacheOpenKeys = _React$useState4[0], setInlineCacheOpenKeys = _React$useState4[1];
  var mountRef = React58.useRef(false);
  ...
  var _React$useState5 = React58.useState(mergedMode), _React$useState6 = _slicedToArray(_React$useState5, 2), internalMode = _React$useState6[0], setInternalMode = _React$useState6[1];
  var _React$useState7 = React58.useState(mergedInlineCollapsed), _React$useState8 = _slicedToArray(_React$useState7, 2), internalInlineCollapsed = _React$useState8[0], setInternalInlineCollapsed = _React$useState8[1];
  ...
  var _React$useState9 = React58.useState(0), _React$useState10 = _slicedToArray(_React$useState9, 2), lastVisibleIndex = _React$useState10[0], setLastVisibleIndex = _React$useState10[1];
  ...
  var registerPathContext = React58.useMemo(function() {
    return {
      registerPath,
      unregisterPath
    };
  }, [registerPath, unregisterPath]);
  var pathUserContext = React58.useMemo(function() {
    return {
      isSubPathKey
    };
  }, [isSubPathKey]);
  ...
  var privateContext = React58.useMemo(function() {
    return {
  ...
  var wrappedChildList = internalMode !== "horizontal" || disabledOverflow ? childList : (
    ...
    childList.map(function(child, index2) {
      return (
        ...
        React58.createElement(InheritableContextProvider, {
          key: child.key,
  ...
  var container = React58.createElement(es_default4, _extends({
    id,
    ref: containerRef,
    ...
    renderRawRest: function renderRawRest(omitItems) {
      ...
      return React58.createElement(SubMenu, {
  ...
  return React58.createElement(PrivateContext_default.Provider, {
    value: privateContext
  }, React58.createElement(IdContext.Provider, {
    value: uuid3
  }, React58.createElement(InheritableContextProvider, {
    prefixCls,
    rootClassName,
  ...
  }, React58.createElement(PathUserContext.Provider, {
    value: pathUserContext
  }, container), React58.createElement("div", {
    style: {
      display: "none"
    },
    "aria-hidden": true
  }, React58.createElement(PathRegisterContext.Provider, {
...
function QRCodeCanvas(props) {
  ...
  let img = null;
  if (imgSrc != null) {
    img = import_react11.default.createElement("img", {
      src: imgSrc,
      key: imgSrc,
      style: { display: "none" },
      onLoad: () => {
  ...
  return import_react11.default.createElement(import_react11.default.Fragment, null, import_react11.default.createElement("canvas", __spreadValues({
    style: canvasStyle,
    height: size,
    width: size,
    ref: _canvas
...
function QRCodeSVG(props) {
  ...
  if (imageSettings != null && calculatedImageSettings != null) {
    ...
    image = import_react11.default.createElement("image", {
  ...
  return import_react11.default.createElement("svg", __spreadValues({
    height: size,
    width: size,
    viewBox: `0 0 ${numCells} ${numCells}`
  }, otherProps), import_react11.default.createElement("path", {
    fill: bgColor,
...
var useMobile = function useMobile2() {
  var _useState = (0, import_react12.useState)(false), _useState2 = _slicedToArray(_useState, 2), mobile = _useState2[0], setMobile = _useState2[1];
  useLayoutEffect_default(function() {
    setMobile(isMobile_default());
  }, []);
  return mobile;
...
qrcode.react/lib/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-OORDWFZT.js.map
