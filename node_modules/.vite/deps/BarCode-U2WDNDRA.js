...
// node_modules/amis-ui/esm/components/BarCode.js
var import_react = __toESM(require_react());
var import_jsbarcode = __toESM(require_JsBarcode());
var BarCode = (
  /** @class */
  function(_super) {
    __extends(BarCode2, _super);
    function BarCode2(props) {
      var _this = _super.call(this, props) || this;
      _this.dom = import_react.default.createRef();
      return _this;
    }
    BarCode2.prototype.componentDidUpdate = function(prevProps) {
      if (this.props.value !== prevProps.value || JSON.stringify(this.props.options) !== JSON.stringify(prevProps.options)) {
        this.renderBarCode();
      }
    };
    BarCode2.prototype.renderBarCode = function() {
      if (this.dom.current) {
        (0, import_jsbarcode.default)(this.dom.current, this.props.value, this.props.options);
      }
    };
    BarCode2.prototype.componentDidMount = function() {
      this.renderBarCode();
    };
    BarCode2.prototype.render = function() {
      return import_react.default.createElement("img", { ref: this.dom });
    };
    return BarCode2;
...
export {
  BarCode,
  BarCode$1 as default
};
//# sourceMappingURL=BarCode-U2WDNDRA.js.map
