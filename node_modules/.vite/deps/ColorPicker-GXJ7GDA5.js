...
// node_modules/amis-ui/esm/components/ColorPicker.js
...
var ColorControl = (
  /** @class */
  function(_super) {
    __extends(ColorControl2, _super);
    function ColorControl2(props) {
      ...
      _this.preview = import_react49.default.createRef();
      _this.input = import_react49.default.createRef();
      return _this;
    }
    ColorControl2.prototype.componentDidUpdate = function(prevProps) {
    ...
    ColorControl2.prototype.handleFocus = function() {
      this.setState({
        isFocused: true
      });
    };
    ColorControl2.prototype.handleBlur = function() {
      this.setState({
        isFocused: false,
        inputValue: this.props.value
      });
    };
    ColorControl2.prototype.focus = function() {
      this.input.current && this.input.current.focus();
    };
    ColorControl2.prototype.blur = function() {
      this.input.current && this.input.current.blur();
    };
    ColorControl2.prototype.open = function(fn) {
    ...
    ColorControl2.prototype.close = function() {
      this.setState({
        isOpened: false
      });
    };
    ColorControl2.prototype.clearValue = function() {
      var _a = this.props, onChange = _a.onChange, resetValue = _a.resetValue;
      onChange(resetValue || "");
    };
    ColorControl2.prototype.handleClick = function() {
      this.state.isOpened ? this.close() : this.open(this.focus);
    };
    ColorControl2.prototype.handleInputChange = function(e) {
      var _this = this;
    ...
    ColorControl2.prototype.validateColor = function(value) {
      if (value === "") {
        return false;
      }
      if (value === "inherit") {
    ...
    ColorControl2.prototype.handleChange = function(color) {
    ...
    ColorControl2.prototype.handleTempChange = function(color) {
    ...
    ColorControl2.prototype.handleConfirm = function() {
      var onChange = this.props.onChange;
      var tempValue = this.state.tempValue;
      onChange(tempValue);
      this.close();
    };
    ColorControl2.prototype.render = function() {
      var _this = this;
      ...
      return import_react49.default.createElement(
        ...
        import_react49.default.createElement(
          "span",
          { onClick: this.handleClick, className: cx("ColorPicker-preview") },
          import_react49.default.createElement("i", { ref: this.preview, className: "".concat(ns, "ColorPicker-previewIcon"), style: { background: this.state.inputValue || "#ccc" } })
        ),
        import_react49.default.createElement("input", { ref: this.input, type: "text", autoComplete: "off", size: 10, className: cx("ColorPicker-input"), value: this.state.inputValue || "", placeholder: __(placeholder), disabled, onChange: this.handleInputChange, onFocus: this.handleFocus, onBlur: this.handleBlur, onClick: this.handleClick, readOnly: mobileUI }),
        clearable && !disabled && value ? import_react49.default.createElement(
          "a",
          { onClick: this.clearValue, className: cx("ColorPicker-clear") },
          import_react49.default.createElement(Icon, { icon: "input-clear", className: "icon" })
        ) : null,
        import_react49.default.createElement(
          "span",
          { className: cx("ColorPicker-arrow") },
          import_react49.default.createElement(Icon, { icon: "right-arrow-bold", className: "icon", onClick: this.handleClick })
        ),
        !mobileUI && isOpened ? import_react49.default.createElement(
          Overlay,
          { placement: placement || "auto", target: function() {
            return (0, import_react_dom.findDOMNode)(_this);
          }, onHide: this.close, container: popOverContainer || function() {
            return (0, import_react_dom.findDOMNode)(_this);
          }, rootClose: false, show: true },
          import_react49.default.createElement(PopOver$1, { classPrefix: ns, className: cx("ColorPicker-popover", popoverClassName), onHide: this.close, overlay: true }, allowCustomColor ? import_react49.default.createElement(Sketch_default, { styles: {}, disableAlpha: !!~["rgb", "hex"].indexOf(format), color: value, presetColors, onChangeComplete: this.handleChange }) : import_react49.default.createElement(Github_default, { color: value, colors: Array.isArray(presetColors) ? presetColors.filter(function(item) {
            return typeof item === "string" || isObject(item);
          }).map(function(item) {
            return typeof item === "string" ? item : isObject(item) ? item === null || item === void 0 ? void 0 : item.color : item;
          }) : void 0, onChangeComplete: this.handleChange }))
        ) : null,
        mobileUI && import_react49.default.createElement(PopUp$1, { className: cx("".concat(ns, "ColorPicker-popup")), container: popOverContainer, isShow: isOpened, onHide: this.handleClick, showConfirm: true, onConfirm: this.handleConfirm }, allowCustomColor ? import_react49.default.createElement(Sketch_default, { styles: {}, disableAlpha: !!~["rgb", "hex"].indexOf(format), color: tempValue, presetColors, onChangeComplete: this.handleTempChange }) : import_react49.default.createElement(Github_default, { color: tempValue, colors: Array.isArray(presetColors) ? presetColors.filter(function(item) {
          return typeof item === "string" || isObject(item);
        }).map(function(item) {
          return typeof item === "string" ? item : isObject(item) ? item === null || item === void 0 ? void 0 : item.color : item;
        }) : void 0, onChangeComplete: this.handleTempChange }))
      );
    };
    ColorControl2.defaultProps = {
      format: "hex",
      clearable: true,
    ...
    ], ColorControl2.prototype, "validateColor", null);
    return ColorControl2;
  }(import_react49.default.PureComponent)
);
var ColorPicker = themeable(localeable(uncontrollable(ColorControl, {
  value: "onChange"
})));
export {
  ColorControl,
...
//# sourceMappingURL=ColorPicker-GXJ7GDA5.js.map
