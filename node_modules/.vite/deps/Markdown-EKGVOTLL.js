...
${fallbackText}${description}
    ...
    function html5Media2(md, options = {}) {
      if (options.messages)
...
// node_modules/amis-ui/esm/components/Markdown.js
var import_react = __toESM(require_react());
var import_markdown_it = __toESM(require_markdown_it());
var import_markdown_it_html5_media = __toESM(require_lib2());
var doMarkdown = (0, import_markdown_it.default)();
doMarkdown.use(import_markdown_it_html5_media.html5Media);
...
var Markdown = (
  ...
  function(_super) {
    ...
    Markdown2.prototype.htmlRef = function(dom) {
      this.dom = dom;
      if (!dom) {
        return;
      }
    ...
    Markdown2.prototype.componentDidUpdate = function(nextProps) {
      if (this.props.content !== nextProps.content) {
        this._render();
      }
    };
    Markdown2.prototype._render = function() {
    ...
    Markdown2.prototype.render = function() {
      return import_react.default.createElement("div", { "data-testid": "markdown-body", className: "markdown-body", ref: this.htmlRef });
    };
...
//# sourceMappingURL=Markdown-EKGVOTLL.js.map
