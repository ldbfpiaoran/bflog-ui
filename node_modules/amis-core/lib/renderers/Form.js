...
var Form = /** @class */ (function (_super) {
    ...
    Form.prototype.renderChildren = function (children, region, otherProps) {
        ...
        if (this.props.mode === 'row') {
            ...
            return (_J$X_("div", { className: cx_1('Form-row') }, children.map(function (control, key) {
                return ~['hidden', 'formula'].indexOf(control.type) ||
                    control.mode === 'inline' ? (_this.renderChild(control, key, otherProps)) : (_J$X_("div", { key: key, className: cx_1("Form-col", control.columnClassName) }, _this.renderChild(control, '', tslib.__assign(tslib.__assign({}, otherProps), { mode: 'row' }))));
            })));
        }
