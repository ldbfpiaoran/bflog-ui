...
var AjaxAction = /** @class */ (function () {
    ...
    AjaxAction.prototype.run = function (action, renderer, event) {
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            var env, silent, messages, api$1, result, responseData, msg, e_1, result;
            var _o;
            return tslib.__generator(this, function (_p) {
                switch (_p.label) {
                    ...
                    case 1:
                        _p.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, env.fetcher(api$1, (_d = action.data) !== null && _d !== void 0 ? _d : {}, (_e = action === null || action === void 0 ? void 0 : action.options) !== null && _e !== void 0 ? _e : {})];
                    case 2:
                        result = _p.sent();
