...
var PopOver = /** @class */ (function (_super) {
    ...
    PopOver.prototype.render = function () {
        ...
        return (_J$X_("div", tslib.__assign({ ref: this.wrapperRef, role: "popover", className: cx("PopOver", className, "PopOver--".concat(helper.camel(activePlacement)), placements[3] ? "PopOver--v-".concat(placements[3]) : ''), style: outerStyle }, rest),
            overlay ? (_J$X_("div", { className: "".concat(ns, "PopOver-overlay"), onClick: onHide })) : null,
            children));
    };
