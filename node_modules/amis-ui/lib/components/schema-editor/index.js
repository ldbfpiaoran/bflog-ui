...
var SchemaEditor = /** @class */ (function (_super) {
    tslib.__extends(SchemaEditor, _super);
    ...
    SchemaEditor.prototype.handleTypeChange = function (type, value, origin) {
        ...
        if (definitions === null || definitions === void 0 ? void 0 : definitions[type]) {
            value = tslib.__assign(tslib.__assign(tslib.__assign({}, value), definitions[type]), { $ref: type });
        }
        return value;
    };
    SchemaEditor.prototype.render = function () {
        var _a = this.props, defaultType = _a.defaultType, cx = _a.classnames, onChange = _a.onChange, renderExtraProps = _a.renderExtraProps, renderModalProps = _a.renderModalProps, translate = _a.translate, locale = _a.locale, classPrefix = _a.classPrefix, rootTypeMutable = _a.rootTypeMutable, showRootInfo = _a.showRootInfo, disabled = _a.disabled, definitions = _a.definitions, enableAdvancedSetting = _a.enableAdvancedSetting, popOverContainer = _a.popOverContainer, placeholder = _a.placeholder, mobileUI = _a.mobileUI;
...
var index = amisCore.themeable(amisCore.localeable(amisCore.uncontrollable(SchemaEditor, {
    value: 'onChange'
})));
