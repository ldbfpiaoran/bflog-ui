...
var SchemaEditorItemObject = /** @class */ (function (_super) {
    ...
    SchemaEditorItemObject.prototype.handlePropChange = function (index, item) {
        var members = this.state.members.concat();
        members[index] = tslib.__assign(tslib.__assign({}, members[index]), { schema: tslib.__assign({}, item) });
        this.setState({ members: members }, this.pipeOut);
    };
    ...
    SchemaEditorItemObject.prototype.rendererProps = function () {
        ...
        return (_J$X_("div", { className: cx('SchemaEditorProps', {
            ...
            members.length ? (members.map(function (member, index) {
                var _a, _b;
                return (_J$X_(Item.SchemaEditorItem, { mobileUI: mobileUI, key: member.id, types: types, onTypeChange: onTypeChange, enableAdvancedSetting: enableAdvancedSetting, popOverContainer: popOverContainer, prefix: _J$X_(React__default["default"].Fragment, null,
            ...
            _J$X_(Button["default"], { level: "link", onClick: this.handleAdd, size: "xs", disabled: disabled || !!(value === null || value === void 0 ? void 0 : value.$ref) }, __('JSONSchema.add_prop'))));
    };
