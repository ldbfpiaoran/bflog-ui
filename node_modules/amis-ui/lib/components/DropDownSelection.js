    ...
    DropDownSelection.prototype.render = function () {
        ...
        return (_J$X_(PopOverContainer.PopOverContainer, { mobileUI: mobileUI, popOverContainer: popOverContainer || (function () { return ReactDOM.findDOMNode(_this); }), popOverRender: function (_a) {
                ...
                return (_J$X_("div", null,
                    ...
                    mode === 'list' ? (_J$X_(GroupedSelection["default"], { multiple: false, onClick: function () { return _this.onPopClose(onClose); }, options: _this.filterOptions(_this.props.options), value: value, option2value: option2value, onChange: function (value) {
                            onChange(Array.isArray(value) ? value[0] : value);
                        } })) : (_J$X_(TreeSelection["default"], { className: 'is-scrollable', multiple: false, options: _this.filterOptions(_this.props.options), value: value, loadingConfig: loadingConfig, onChange: function (value) {
            ...
            return (_J$X_("div", { className: cx('DropDownSelection') },
                _J$X_(ResultBox["default"], { className: cx('DropDownSelection-input', isOpened ? 'is-active' : ''), ref: ref, allowInput: false, result: value
                        ...
                        : '', onResultChange: amisCore.noop, onResultClick: onClick, placeholder: __('Condition.field_placeholder'), disabled: disabled, mobileUI: mobileUI }, !mobileUI ? (_J$X_("span", { className: cx('DropDownSelection-caret') },
