...
function getSelectedRows(dataSource, selectedRowKeys, rowSelectionKeyField, childrenColumnName) {
    ...
    dataSource.forEach(function (data) {
        ...
        if (checkChildrenRow(data, childrenColumnName)) {
            ...
            selectedRows = tslib.__spreadArray(tslib.__spreadArray([], tslib.__read(selectedRows), false), tslib.__read(childrenSelected.selectedRows), false);
            unSelectedRows = tslib.__spreadArray(tslib.__spreadArray([], tslib.__read(unSelectedRows), false), tslib.__read(childrenSelected.unSelectedRows), false);
        }
    });
