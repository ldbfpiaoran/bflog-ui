...
var HeadCellSort = /** @class */ (function (_super) {
    ...
    HeadCellSort.prototype.render = function () {
        ...
        return (_J$X_("span", { className: cx('TableCell-sortBtn', 'aaa'), onClick: function () { return tslib.__awaiter(_this, void 0, void 0, function () {
            ...
            _J$X_("i", { className: cx('TableCell-sortBtn--down', active && this.state.orderDir === 'desc' ? 'is-active' : '') },
                _J$X_(icons.Icon, { icon: "sort-desc", className: "icon", iconContent: "table-sort-down" })),
            _J$X_("i", { className: cx('TableCell-sortBtn--up', active && this.state.orderDir === 'asc' ? 'is-active' : '') },
                _J$X_(icons.Icon, { icon: "sort-asc", className: "icon", iconContent: "table-sort-up" })),
            _J$X_("i", { className: cx('TableCell-sortBtn--default', active ? '' : 'is-active') },
                _J$X_(icons.Icon, { icon: "sort-default", className: "icon", iconContent: "table-sort-default" }))));
    };
    return HeadCellSort;
