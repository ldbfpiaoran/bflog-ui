...
export declare function getSelectedRows(dataSource: Array<any>, selectedRowKeys: Array<string | number>, rowSelectionKeyField: string, childrenColumnName: string): {
    selectedRows: any[];
    unSelectedRows: any[];
};
...
export declare function hasFixedColumn(columns: Array<ColumnProps | SummaryProps>): number | ColumnProps | SummaryProps | ((predicate: (value: ColumnProps | SummaryProps, index: number, obj: (ColumnProps | SummaryProps)[]) => unknown, thisArg?: any) => number) | (() => IterableIterator<ColumnProps | SummaryProps>) | (() => {
    ...
    keys: boolean;
    values: boolean;
}) | (<U>(callbackfn: (value: ColumnProps | SummaryProps, index: number, array: (ColumnProps | SummaryProps)[]) => U, thisArg?: any) => U[]) | {
