...
var Avatar = /** @class */ (function (_super) {
    ...
    Avatar.prototype.render = function () {
        ...
        return (_J$X_("span", { className: cx("Avatar", className, prefix + shape, sizeClass), style: tslib.__assign(tslib.__assign({}, sizeStyle), style), ref: this.avatarRef }, childrenRender));
    };
    Avatar.defaultProps = {
        shape: 'circle',
        size: 'default',
