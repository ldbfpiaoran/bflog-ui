...
var DateRangePicker = /** @class */ (function (_super) {
    ...
    DateRangePicker.prototype.renderMonth = function (props, month, year, date) {
        ...
        return (_J$X_("td", tslib.__assign({}, omit__default["default"](props, 'viewDate'), others),
            _J$X_("span", null, monthStrFixedLength)));
    };
    ...
    DateRangePicker.prototype.render = function () {
        ...
        var __ = this.props.translate;
        var calendarMobile = (_J$X_(CalendarMobile["default"], { timeFormat: curTimeFormat, displayForamt: displayFormat || inputFormat, startDate: startDate, endDate: endDate, minDate: minDate, maxDate: maxDate, minDuration: minDuration, maxDuration: maxDuration, dateFormat: curDateFormat, embed: embed, viewMode: viewMode, close: this.close, confirm: this.confirm, onChange: this.handleMobileChange, footerExtra: this.renderShortcuts(ranges || shortcuts), showViewMode: viewMode === 'quarters' || viewMode === 'months' ? 'years' : 'months' }));
        if (embed) {
