...
var ContextMenu = /** @class */ (function (_super) {
    ...
    ContextMenu.prototype.handleEnter = function (menu) {
        // 智能定位，选择一个合适的对齐方式。
        var info = amisCore.calculatePosition('auto', menu.lastChild, menu.children[1], document.body);
    ...
    ContextMenu.prototype.render = function () {
        ...
        return (_J$X_(Transition__default["default"], { mountOnEnter: true, unmountOnExit: true, onEnter: this.handleEnter, in: this.state.isOpened, timeout: 500 }, function (status) { return (_J$X_("div", { ref: _this.menuRef, role: "contextmenu", className: cx('ContextMenu', {
            ...
            _J$X_("div", { className: cx("ContextMenu-cursor"), style: { left: "".concat(_this.state.x, "px"), top: "".concat(_this.state.y, "px") } }),
            _J$X_("div", { style: { left: "".concat(_this.state.x, "px"), top: "".concat(_this.state.y, "px") }, className: cx("ContextMenu-menu", fadeStyles[status]) },
                _J$X_("ul", { className: cx('ContextMenu-list') }, _this.renderMenus(_this.state.menus))))); }));
    };
    ContextMenu.instance = null;
    tslib.__decorate([
        amisCore.autobind,
        tslib.__metadata("design:type", Function),
        tslib.__metadata("design:paramtypes", [Object, Array, Function]),
    ...
    return tslib.__awaiter(this, void 0, void 0, function () {
        return tslib.__generator(this, function (_a) {
            return [2 /*return*/, ContextMenu.getInstance().then(function (instance) {
                    return instance.openContextMenus(info, menus, onClose);
                })];
        });
    });
}
