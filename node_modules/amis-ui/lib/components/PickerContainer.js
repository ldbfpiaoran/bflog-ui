...
var PickerContainer = /** @class */ (function (_super) {
    ...
    function PickerContainer() {
        ...
        _this.bodyRef = React__default["default"].createRef();
        return _this;
    }
    ...
    PickerContainer.prototype.render = function () {
        var _this = this;
        var _a = this.props, children = _a.children, popOverRender = _a.bodyRender, title = _a.title, showTitle = _a.showTitle, headerClassName = _a.headerClassName, bodyClassName = _a.bodyClassName, __ = _a.translate, size = _a.size, showFooter = _a.showFooter, closeOnEsc = _a.closeOnEsc, popOverContainer = _a.popOverContainer, mobileUI = _a.mobileUI, disabled = _a.disabled;
        return (_J$X_(React__default["default"].Fragment, null,
            ...
            _J$X_(ConfirmBox["default"], { type: "dialog", size: size, closeOnEsc: closeOnEsc, show: this.state.isOpened, onCancel: this.close, title: title || __('Select.placeholder'), showTitle: showTitle, headerClassName: headerClassName, bodyClassName: bodyClassName, showFooter: showFooter, beforeConfirm: this.confirm, popOverContainer: popOverContainer, mobileUI: mobileUI, disabled: disabled }, function (_a) {
                var popOverContainer = _a.popOverContainer, loading = _a.loading;
                return popOverRender(tslib.__assign(tslib.__assign({}, _this.state), { ref: _this.bodyRef, setState: _this.updateState, onClose: _this.close, onChange: _this.handleChange, onConfirm: _this.confirm, popOverContainer: popOverContainer, loading: loading }));
            })));
    };
    tslib.__decorate([
        amisCore.autobind,
