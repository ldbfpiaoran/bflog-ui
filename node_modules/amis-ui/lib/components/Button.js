...
var Button = /** @class */ (function (_super) {
    ...
    Button.prototype.renderButton = function () {
        ...
        return (_J$X_(Comp, tslib.__assign({ type: Comp === 'input' || Comp === 'button' ? type : undefined }, amisCore.pickEventsProps(rest), { onClick: rest.onClick && disabled ? function () { } : rest.onClick, href: href, className: cx(overrideClassName
                ? ''
                : (_a = {
                        'Button': true
                    },
