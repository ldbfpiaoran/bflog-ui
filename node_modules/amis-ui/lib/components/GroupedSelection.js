...
var GroupedSelection = /** @class */ (function (_super) {
    ...
    GroupedSelection.prototype.renderPureOption = function (option, index, key, styles) {
        ...
        return (_J$X_("div", { key: index, style: styles, className: cx('GroupedSelection-item', itemClassName, option.className, disabled || option.disabled ? 'is-disabled' : '', !!~valueArray.indexOf(option) ? 'is-active' : ''), onClick: function () { return _this.toggleOption(option); } },
