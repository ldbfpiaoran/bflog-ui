...
function ConfirmBox(_a) {
    ...
    function renderDialog() {
        return mobileUI ? (_J$X_(PopUp["default"], { isShow: show, showConfirm: true, onConfirm: handleConfirm, onHide: onCancel, container: popOverContainer }, typeof children === 'function'
            ? children({
                bodyRef: bodyRef,
                loading: loading,
                popOverContainer: getPopOverContainer
            })
            : children)) : (_J$X_(Modal["default"], { size: size, closeOnEsc: closeOnEsc, show: show, onHide: onCancel, container: popOverContainer, className: className },
            ...
            (showFooter !== null && showFooter !== void 0 ? showFooter : true) ? (_J$X_(Modal["default"].Footer, { className: footerClassName },
                ...
                _J$X_(Button["default"], { disabled: loading, onClick: onCancel }, __('cancel')),
                _J$X_(Button["default"], { disabled: loading || disabled, onClick: handleConfirm, level: "primary" }, __('confirm')))) : null));
    }
