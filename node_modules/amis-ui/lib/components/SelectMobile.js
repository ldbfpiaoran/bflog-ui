...
var SelectMobile = /** @class */ (function (_super) {
    ...
    SelectMobile.prototype.render = function () {
        ...
        return (_J$X_(PopUp["default"], { className: cx("Select-popup"), container: popOverContainer, isShow: isOpen, showConfirm: true, onConfirm: this.onConfirm, onHide: onClose }, multiple ? (menu) : (_J$X_(Picker["default"], { className: 'Select-picker', columns: {
