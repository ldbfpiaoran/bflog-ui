...
var Alert = /** @class */ (function (_super) {
    ...
    Alert.prototype.render = function () {
        ...
        return (_J$X_(Modal["default"], { show: this.state.show, onHide: this.handleCancel, container: container, ref: this.modalRef, closeOnEsc: this.state.closeOnEsc, size: this.state.size },
...
var alert = function (content, title) { return tslib.__awaiter(void 0, void 0, void 0, function () {
    var instance;
    return tslib.__generator(this, function (_a) {
        switch (_a.label) {
