...
var CustomMonthsView = /** @class */ (function (_super) {
    ...
    function CustomMonthsView(props) {
        ...
        _this.renderMonth = function (props, month, year, date) {
            ...
            var localMoment = props.viewDate, rest = tslib.__rest(props, ["viewDate"]);
            var monthStr = localMoment.month(month).format(__('MMM'));
            var strLength = 3;
            // Because some months are up to 5 characters long, we want to
            // use a fixed string length for consistency
            var monthStrFixedLength = monthStr.substring(0, strLength);
            return (_J$X_("td", tslib.__assign({}, rest),
        ...
        _this.renderPicker = function () {
            ...
            return (_J$X_(Picker["default"], { translate: _this.props.translate, locale: _this.props.locale, title: title, columns: _this.state.columns, value: _this.state.pickerValue, onChange: _this.onPickerChange, onConfirm: _this.onConfirm, onClose: _this.props.onClose }));
        };
    ...
    CustomMonthsView.prototype.renderMonths = function () {
        ...
        while (i < 12) {
            ...
            if (months.length === 3) {
                rows.push(_J$X_('tr', { key: i }, months));
                months = [];
            }
            i++;
        }
    ...
    CustomMonthsView.prototype.render = function () {
        ...
        return (_J$X_("div", { className: "rdtMonths" },
            showYearHead && (_J$X_("table", { className: "headerTable" },
                _J$X_("thead", null,
                    _J$X_("tr", null,
                        _J$X_("th", { className: "rdtPrev", onClick: this.props.subtractTime(1, 'years') }, "\u00AB"),
                        canClick ? (_J$X_("th", { className: "rdtSwitch", onClick: this.props.showView('years') }, this.props.viewDate.format(__('dateformat.year')))) : (_J$X_("th", { className: "rdtSwitch" }, this.props.viewDate.format(__('dateformat.year')))),
                        _J$X_("th", { className: "rdtNext", onClick: this.props.addTime(1, 'years') }, "\u00BB"))))),
            _J$X_("table", null,
                _J$X_("tbody", null, this.renderMonths()))));
    };
