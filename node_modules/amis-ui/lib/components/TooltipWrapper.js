...
var TooltipWrapper = /** @class */ (function (_super) {
    ...
    TooltipWrapper.prototype.render = function () {
        ...
        var tooltipObj = tslib.__assign({ placement: props.placement, container: props.container, trigger: props.trigger, rootClose: props.rootClose, tooltipClassName: props.tooltipClassName, style: props.style, mouseLeaveDelay: props.delay, tooltipTheme: props.tooltipTheme }, (typeof props.tooltip === 'string'
            ...
            : props.tooltip));
        var title = tooltipObj.title, content = tooltipObj.content, placement = tooltipObj.placement, container = tooltipObj.container, trigger = tooltipObj.trigger, rootClose = tooltipObj.rootClose, tooltipClassName = tooltipObj.tooltipClassName, tooltipBodyClassName = tooltipObj.tooltipBodyClassName, style = tooltipObj.style, _a = tooltipObj.disabled, disabled = _a === void 0 ? false : _a, offset = tooltipObj.offset, _b = tooltipObj.tooltipTheme, tooltipTheme = _b === void 0 ? 'light' : _b, _c = tooltipObj.showArrow, showArrow = _c === void 0 ? true : _c, children = tooltipObj.children, filterHtml = tooltipObj.filterHtml;
        var childProps = {
            key: 'target'
        };
        ...
        return [
            ...
            _J$X_(amisCore.Overlay, { key: "overlay", target: this.getTarget, show: this.state.show && !disabled, onHide: this.handleHide, rootClose: rootClose, placement: placement, container: container, offset: Array.isArray(offset) ? offset : [0, 0] },
                _J$X_(Tooltip["default"], { title: typeof title === 'string' ? title : undefined, style: style, className: tooltipClassName, tooltipTheme: tooltipTheme, showArrow: showArrow, bodyClassName: tooltipBodyClassName, onMouseEnter: ~triggers.indexOf('hover') ? this.tooltipMouseEnter : function () { }, onMouseLeave: ~triggers.indexOf('hover') ? this.tooltipMouseLeave : function () { } }, children ? (_J$X_(React__default["default"].Fragment, null, typeof children === 'function' ? children() : children)) : (_J$X_(Html["default"], { html: typeof content === 'string' ? content : '', filterHtml: filterHtml }))))
        ];
    };
