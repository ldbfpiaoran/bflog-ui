...
var CityArea = React.memo(function (props) {
    ...
    var loadDb = function () {
        Promise.resolve().then(function() {return new Promise(function(fullfill) {require(['./CityDB.js'], function(mod) {fullfill(tslib.__importStar(mod))})})}).then(function (db) {
    ...
    return (_J$X_("div", { className: cx("CityArea"), style: style },
        _J$X_(ResultBox["default"], { className: cx('CityArea-Input', isOpened ? 'is-active' : ''), allowInput: false, result: result, onResultChange: function () { }, onResultClick: function () { return setIsOpened(!isOpened); }, placeholder: __('Select.placeholder'), mobileUI: mobileUI }),
