...
var UserSelect = /** @class */ (function (_super) {
    ...
    UserSelect.prototype.render = function () {
        ...
        return (_J$X_("div", { className: cx('UserSelect') },
            showResultBox ? (_J$X_(ResultBox["default"], { className: cx('UserSelect-input', isOpened ? 'is-active' : ''), allowInput: false, result: this.getResult(), itemRender: function (option) {
