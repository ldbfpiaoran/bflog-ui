...
var TabComponent = /** @class */ (function (_super) {
    ...
    TabComponent.prototype.render = function () {
        var _this = this;
        var _a = this.props, cx = _a.classnames, mountOnEnter = _a.mountOnEnter, reload = _a.reload, unmountOnExit = _a.unmountOnExit, eventKey = _a.eventKey, activeKey = _a.activeKey, children = _a.children, className = _a.className, swipeable = _a.swipeable, mobileUI = _a.mobileUI;
        return (_J$X_(Transition__default["default"], { in: activeKey === eventKey, mountOnEnter: mountOnEnter, unmountOnExit: typeof reload === 'boolean' ? reload : unmountOnExit, timeout: 500 }, function (status) {
            ...
            return (_J$X_("div", { ref: _this.contentRef, className: cx(transitionStyles[status], activeKey === eventKey ? 'is-active' : '', 'Tabs-pane', className), onTouchStart: swipeable && mobileUI ? _this.onTouchStart : amisCore.noop, onTouchMove: swipeable && mobileUI ? _this.onTouchMove : amisCore.noop, onTouchEnd: swipeable && mobileUI ? _this.onTouchEnd : amisCore.noop, onTouchCancel: swipeable && mobileUI ? _this.onTouchEnd : amisCore.noop }, children));
        }));
    };
    tslib.__decorate([
        amisCore.autobind,
...
var Tabs = /** @class */ (function (_super) {
    ...
    Tabs.prototype.renderNav = function (child, index, showClose) {
        ...
        var _b = child.props, eventKey = _b.eventKey, disabled = _b.disabled, icon = _b.icon, iconPosition = _b.iconPosition, title = _b.title, toolbar = _b.toolbar, tabClassName = _b.tabClassName, tabClosable = _b.closable, tip = _b.tip, hash = _b.hash;
        ...
        return (_J$X_("li", { className: cx('Tabs-link', activeKey === eventKey ? 'is-active' : '', disabled ? 'is-disabled' : '', tabClassName), key: this.generateTabKey(hash, eventKey, index), onClick: function () { return (disabled ? '' : _this.handleSelect(eventKey)); }, onDoubleClick: function () {
                editable &&
                    typeof title === 'string' &&
            ...
            showClose && (tabClosable !== null && tabClosable !== void 0 ? tabClosable : closable) && (_J$X_("span", { className: cx('Tabs-link-close'), onClick: function (e) {
                    e.stopPropagation();
                    _this.props.onClose &&
    ...
    Tabs.prototype.renderArrow = function (type) {
        ...
        return isOverflow ? (_J$X_("div", { onClick: function () { return _this.handleArrow(type); }, className: cx('Tabs-linksContainer-arrow', 'Tabs-linksContainer-arrow--' + type, disabled && 'Tabs-linksContainer-arrow--disabled') },
    ...
    Tabs.prototype.renderNavs = function (showClose) {
        ...
        if (typeof collapseOnExceed == 'number' &&
            ...
            doms.push(_J$X_(PopOverContainer.PopOverContainer, { key: "togglor", placement: "center-bottom-center-top center-top-center-bottom", popOverClassName: cx('Tabs-PopOver'), popOverContainer: popOverContainer || (function () { return ReactDOM.findDOMNode(_this); }), popOverRender: function (_a) {
                ...
                return (_J$X_("li", { className: cx('Tabs-link', rest_1.some(function (item) { return ~item.props.className.indexOf('is-active'); })
                        ? 'is-active'
                        : '') },
    ...
    Tabs.prototype.render = function () {
        ...
        var toolButtons = (_J$X_(React__default["default"].Fragment, null,
            addable && (_J$X_("div", { className: cx('Tabs-addable'), onClick: function () { return _this.handleAddBtn(); } },
                _J$X_(icons.Icon, { icon: "plus", className: cx('Tabs-addable-icon') }),
                addBtnText)),
            toolbar));
        return (_J$X_("div", { className: cx("Tabs", (_a = {},
            ...
            !['vertical', 'sidebar', 'chrome'].includes(mode) ? (_J$X_("div", { className: cx('Tabs-linksContainer-wrapper', toolbar && 'Tabs-linksContainer-wrapper--toolbar'), ref: this.resizeDom },
                _J$X_("div", { className: cx('Tabs-linksContainer', isOverflow && 'Tabs-linksContainer--overflow') },
            ...
            draggable && (_J$X_("div", { className: cx('Tabs-drag-tip'), ref: this.dragTipRef }))));
    };
    Tabs.defaultProps = {
        mode: '',
        contentClassName: '',
