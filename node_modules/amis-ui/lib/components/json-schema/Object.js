...
function InputJSONSchemaObject(props) {
    var _a, _b;
    var cx = props.classnames, value = props.value, onChange = props.onChange, disabled = props.disabled, __ = props.translate, renderKey = props.renderKey, collapsable = props.collapsable, renderValue = props.renderValue, mobileUI = props.mobileUI;
    ...
    var _c = tslib.__read(React__default["default"].useState(buildMembers(props.schema, props.value)), 2), members = _c[0], setMembers = _c[1];
    ...
    var onMemberChange = function (member, memberValue) {
        var _a;
        var newValue = tslib.__assign(tslib.__assign({}, props.value), (_a = {}, _a[member.name] = memberValue, _a));
    ...
    var onMemberKeyChange = function (member, memberValue) {
        ...
        var newValue = tslib.__assign({}, props.value);
        var m = members.concat();
        m.splice(idx, 1, tslib.__assign(tslib.__assign({}, member), { schema: ((_b = (_a = props.schema) === null || _a === void 0 ? void 0 : _a.properties) === null || _b === void 0 ? void 0 : _b[memberValue]) || {
                type: 'string'
    ...
    return (_J$X_(React__default["default"].Fragment, null,
        ...
        _J$X_("div", { className: cx('JSONSchemaObject', {
            ...
            collapsed ? (renderValue ? (_J$X_(Item.InputJSONSchemaItem, tslib.__assign({}, props, { value: value, onChange: onChange, schema: {
                    type: 'string'
                ...
                return (_J$X_("div", { key: member.key, className: cx('JSONSchemaMember') },
                    ...
                    _J$X_("div", { className: cx('JSONSchemaMember-value') },
                        _J$X_(Item.InputJSONSchemaItem, tslib.__assign({}, props, { value: value === null || value === void 0 ? void 0 : value[member.name], onChange: onMemberChange.bind(null, member), schema: member.schema || {
                                type: 'string'
            ...
            allowAdd && !collapsed ? (_J$X_(Button["default"], { level: "link", onClick: handleAdd, size: "xs", disabled: disabled }, __('JSONSchema.add_prop'))) : null)));
}
