...
var UserTabSelect = /** @class */ (function (_super) {
    ...
    UserTabSelect.prototype.render = function () {
        ...
        return (_J$X_("div", { className: cx('UserTabSelect') },
            _J$X_(ResultBox["default"], { className: cx('UserTabSelect-input', isOpened ? 'is-active' : ''), allowInput: false, result: this.getResult(), onResultChange: this.handleImmediateChange, onResultClick: this.onOpen, placeholder: placeholder, mobileUI: mobileUI }),
