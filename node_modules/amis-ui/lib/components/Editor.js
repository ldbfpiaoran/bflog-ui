...
var Editor = /** @class */ (function (_super) {
    ...
    Editor.prototype.loadMonaco = function () {
        var _this = this;
        Promise.resolve().then(function() {return new Promise(function(fullfill) {require(['monaco-editor'], function(mod) {fullfill(tslib.__importStar(mod))})})}).then(function (monaco) { return _this.initMonaco(monaco); });
    };
...
var Editor$1 = amisCore.themeable(amisCore.localeable(Editor));
