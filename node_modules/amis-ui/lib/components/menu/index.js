...
var Menu = /** @class */ (function (_super) {
    ...
    Menu.prototype.renderExpandIcon = function (ctx) {
        ...
        return (_J$X_("span", { key: "expand-toggle", className: cx('Nav-Menu-submenu-arrow'), onClick: function (e) {
                _this.handleToggleExpand(ctx);
                e.preventDefault();
            } }, !React__default["default"].isValidElement(expandIcon) ? (_J$X_(icons.Icon, { icon: typeof expandIcon === 'string' ? expandIcon : 'right-arrow-bold', className: "icon" })) : (expandIcon)));
    };
    Menu.prototype.renderMenuContent = function (list, level) {
        var _this = this;
        var _a = this.props, renderLink = _a.renderLink, cx = _a.classnames, themeColor = _a.themeColor, disabled = _a.disabled, badge = _a.badge, data = _a.data, isActive = _a.isActive, collapsed = _a.collapsed, overflowedIndicator = _a.overflowedIndicator, overflowMaxCount = _a.overflowMaxCount, popupClassName = _a.popupClassName;
        return list.map(function (item, index) {
            ...
            if ((link && link.defer && !link.loaded) ||
                ...
                return (_J$X_(SubMenu["default"], tslib.__assign({}, item, { key: item.id, disabled: itemDisabled || link.loading, active: isActive(item), badge: badge, renderLink: renderLink, depth: level || 1, popupClassName: popupClassName }), _this.renderMenuContent(item.children || [], item.depth + 1)));
            }
            return item.mode === 'divider' ? (_J$X_(RcMenu.Divider, { key: item.id, className: cx("Nav-Menu-item-divider", (_a = {},
                    ...
                    _a)) })) : (_J$X_(MenuItem["default"], tslib.__assign({}, item, { key: item.id, disabled: itemDisabled, renderLink: renderLink, badge: badge, data: data, depth: level || 1, order: index, overflowedIndicator: overflowedIndicator, overflowMaxCount: overflowMaxCount })));
        });
    };
...
var index = amisCore.themeable(Menu);
