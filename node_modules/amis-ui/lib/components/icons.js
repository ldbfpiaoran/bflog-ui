...
function Icon(_a) {
    ...
    if (React__default["default"].isValidElement(icon)) {
        return React__default["default"].cloneElement(icon, tslib.__assign(tslib.__assign({}, (icon.props || {})), { className: cx__default["default"](cx(className, classNameProp), icon.props.className), style: style, onClick: onClick }));
    }
    if (iconContent) {
        // 从css变量中获取icon
        ...
        return (_J$X_("div", { onClick: onClick, className: cx(iconContent, className, classNameProp), ref: refFn, style: style }));
    }
    // 获取注册的icon
    var Component = getIcon(icon);
    if (Component) {
        return (_J$X_(Component, { onClick: onClick, className: cx(className, "icon-".concat(icon), classNameProp), 
            // @ts-ignore
    ...
    if (isObject__default["default"](icon) &&
        ...
        if (!document.getElementById(id)) {
            ...
            return (_J$X_("svg", { onClick: onClick, className: cx('icon', 'icon-object', className, classNameProp), style: style },
    ...
    if (typeof icon === 'string' && icon.startsWith('<svg')) {
        ...
        var svgHTML = React.createElement('svg', {
            onClick: onClick,
    ...
    if (isURLIcon) {
        return (_J$X_("img", { onClick: onClick, className: cx("".concat(classPrefix, "Icon"), className, classNameProp), src: icon, style: style }));
    }
    // icon是普通字符串
    ...
    if (isIconfont) {
        return (_J$X_("i", { onClick: onClick, className: cx(icon, className, classNameProp, iconPrefix), style: style }));
    }
    // 没有合适的图标
