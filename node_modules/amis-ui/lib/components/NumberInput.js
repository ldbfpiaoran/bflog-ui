...
var NumberInput = /** @class */ (function (_super) {
    ...
    NumberInput.prototype.render = function () {
        ...
        return (_J$X_(React__default["default"].Fragment, null, displayMode === 'enhance' ? (_J$X_("div", { className: cx('Number--enhance', disabled ? 'Number--enhance-disabled' : '', showSteps === false ? 'Number--enhance-no-steps' : '', (_a = {},
            ...
            _J$X_("div", { className: cx('Number--enhance-left-icon', value && value === min ? 'Number--enhance-border-min' : '', disabled ? 'Number--enhance-border-disabled' : '', readOnly ? 'Number--enhance-border-readOnly' : ''), onClick: function () { return _this.handleEnhanceModeChange('subtract'); } },
            ...
            this.renderBase(),
            _J$X_("div", { className: cx('Number--enhance-right-icon', value && value === max ? 'Number--enhance-border-max' : '', disabled ? 'Number--enhance-border-disabled' : '', readOnly ? 'Number--enhance-border-readOnly' : ''), onClick: function () { return _this.handleEnhanceModeChange('add'); } },
    ...
    NumberInput.normalizeValue = function (value, min, max, precision, resetValue, clearValueOnEmpty, isBig) {
        ...
        if (!isBig && getMiniDecimal.getNumberPrecision(value) !== precision) {
            value = getMiniDecimal__default["default"](getMiniDecimal.toFixed(getMiniDecimal.num2str(value), '.', precision)).toNumber();
        }
        return value;
    };
    /**
