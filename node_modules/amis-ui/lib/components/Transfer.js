...
var Transfer = /** @class */ (function (_super) {
    ...
    function Transfer() {
        ...
        _this.lazySearch = debounce__default["default"](function () { return tslib.__awaiter(_this, void 0, void 0, function () {
    ...
    Transfer.prototype.renderSelect = function (props) {
        ...
        return (_J$X_(React__default["default"].Fragment, null,
            _J$X_("div", { className: cx('Transfer-title', selectMode === 'table' ? 'Transfer-title--light' : '') },
                _J$X_("span", null,
                    includes__default["default"](['list', 'tree'], selectMode) ? (_J$X_(Checkbox["default"], { checked: checkedPartial, partial: checkedPartial && !checkedAll, onChange: props.onToggleAll || this.toggleAll, size: "sm" })) : null,
                    ...
                    statistics !== false ? (_J$X_("span", null,
                        ...
                        this.availableOptions.length,
                        "\uFF09")) : null),
                includes__default["default"](['chained', 'associated'], selectMode) ? (_J$X_("a", { onClick: props.onToggleAll || this.toggleAll, className: cx('Transfer-checkAll', disabled || !options.length ? 'is-disabled' : '') }, __('Select.checkAll'))) : null),
            onSearch ? (_J$X_("div", { className: cx('Transfer-search', { 'is-mobile': mobileUI }) },
                _J$X_(InputBox["default"], { value: this.state.inputValue, onChange: this.handleSearch, clearable: false, onKeyDown: this.handleSearchKeyDown, placeholder: searchPlaceholder, mobileUI: mobileUI }, this.state.searchResult !== null ? (_J$X_("a", { onClick: this.handleSeachCancel },
    ...
    Transfer.prototype.renderFooter = function () {
        var _a = this.props, cx = _a.classnames, pagination = _a.pagination, onPageChange = _a.onPageChange;
        return (pagination === null || pagination === void 0 ? void 0 : pagination.enable) ? (_J$X_("div", { className: cx('Transfer-footer') },
            _J$X_(Pagination["default"], { className: cx('Transfer-footer-pagination', pagination.className), activePage: pagination.page, perPage: pagination.perPage, total: pagination.total, layout: pagination.layout, maxButtons: pagination.maxButtons, perPageAvailable: pagination.perPageAvailable, popOverContainer: pagination.popOverContainer, popOverContainerSelector: pagination.popOverContainerSelector, onPageChange: onPageChange }))) : null;
    };
    ...
    Transfer.prototype.renderOptions = function (props) {
        ...
        return selectMode === 'table' ? (_J$X_(TableSelection["default"], { className: cx('Transfer-selection'), columns: columns, options: options || [], value: value, disabled: disabled, onChange: onChange, option2value: option2value, onDeferLoad: onDeferLoad, cellRender: cellRender, multiple: multiple, virtualThreshold: virtualThreshold, itemHeight: itemHeight, virtualListHeight: virtualListHeight, checkAllLabel: checkAllLabel, checkAll: checkAll })) : selectMode === 'tree' ? (_J$X_(Tree["default"], { ref: this.domRef, placeholder: noResultsText, className: cx('Transfer-selection'), options: options, value: value, onChange: onChange, onlyChildren: onlyChildren !== null && onlyChildren !== void 0 ? onlyChildren : !this.state.isTreeDeferLoad, itemRender: this.optionItemRender, onDeferLoad: onDeferLoad, joinValues: false, showIcon: false, multiple: multiple, cascade: true, labelField: labelField, valueField: valueField, virtualThreshold: virtualThreshold, itemHeight: itemHeight, loadingConfig: loadingConfig, checkAllLabel: checkAllLabel, checkAll: checkAll })) : selectMode === 'chained' ? (_J$X_(ChainedSelection["default"], { className: cx('Transfer-selection'), options: options || [], value: value, disabled: disabled, onChange: onChange, option2value: option2value, onDeferLoad: onDeferLoad, itemRender: this.optionItemRender, multiple: multiple, labelField: labelField, valueField: valueField, virtualThreshold: virtualThreshold, itemHeight: itemHeight, virtualListHeight: virtualListHeight, loadingConfig: loadingConfig, checkAllLabel: checkAllLabel, checkAll: checkAll })) : selectMode === 'associated' ? (_J$X_(AssociatedSelection["default"], { className: cx('Transfer-selection'), options: options || [], value: value, disabled: disabled, onChange: onChange, option2value: option2value, onDeferLoad: onDeferLoad, columns: columns, leftOptions: leftOptions || [], leftMode: leftMode, rightMode: rightMode, leftDefaultValue: leftDefaultValue, itemRender: this.optionItemRender, multiple: multiple, labelField: labelField, valueField: valueField, deferField: deferField, virtualThreshold: virtualThreshold, itemHeight: itemHeight, virtualListHeight: virtualListHeight, loadingConfig: loadingConfig, checkAllLabel: checkAllLabel, checkAll: checkAll })) : (_J$X_(GroupedSelection["default"], { className: cx('Transfer-selection'), options: options || [], value: value, disabled: disabled, onChange: onChange, option2value: option2value, onDeferLoad: onDeferLoad, itemRender: this.optionItemRender, multiple: multiple, labelField: labelField, valueField: valueField, virtualThreshold: virtualThreshold, itemHeight: itemHeight, virtualListHeight: virtualListHeight, checkAllLabel: checkAllLabel, checkAll: checkAll }));
    };
    Transfer.prototype.renderResult = function () {
        var _a = this.props, columns = _a.columns, options = _a.options, disabled = _a.disabled, option2value = _a.option2value, cx = _a.classnames, cellRender = _a.cellRender, onChange = _a.onChange, value = _a.value, resultSearchable = _a.resultSearchable, resultSearchPlaceholder = _a.resultSearchPlaceholder, onResultSearch = _a.onResultSearch, sortable = _a.sortable, labelField = _a.labelField, __ = _a.translate, _b = _a.placeholder, placeholder = _b === void 0 ? __('Transfer.selectFromLeft') : _b, virtualThreshold = _a.virtualThreshold, itemHeight = _a.itemHeight, loadingConfig = _a.loadingConfig, showInvalidMatch = _a.showInvalidMatch, pagination = _a.pagination, accumulatedOptions = _a.accumulatedOptions;
                ...
                _J$X_("div", { className: cx('Transfer-title', tableType ? 'Transfer-table-title' : '', selectMode === 'table' ? 'Transfer-title--light' : '') },
                    _J$X_("span", null,
                        ...
                        statistics !== false ? (_J$X_("span", null,
                            ...
                            this.valueArray.length,
                            "\uFF09")) : null),
                    _J$X_("a", { onClick: this.clearAll, className: cx('Transfer-clearAll', disabled || !this.valueArray.length ? 'is-disabled' : '') }, __('clear'))),
                this.renderResult())));
    };
