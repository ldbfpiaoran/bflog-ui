...
var TransferPicker = /** @class */ (function (_super) {
    ...
    TransferPicker.prototype.render = function () {
        var _this = this;
        var _a = this.props, cx = _a.classnames, value = _a.value, __ = _a.translate, disabled = _a.disabled, className = _a.className, onChange = _a.onChange, size = _a.size, borderMode = _a.borderMode, _b = _a.labelField, labelField = _b === void 0 ? 'label' : _b, mobileUI = _a.mobileUI, popOverContainer = _a.popOverContainer, maxTagCount = _a.maxTagCount, overflowTagPopover = _a.overflowTagPopover, rest = tslib.__rest(_a, ["classnames", "value", "translate", "disabled", "className", "onChange", "size", "borderMode", "labelField", "mobileUI", "popOverContainer", "maxTagCount", "overflowTagPopover"]);
        return (_J$X_(PickerContainer["default"], { title: __('Select.placeholder'), onFocus: this.onFoucs, onClose: this.onBlur, mobileUI: mobileUI, popOverContainer: popOverContainer, bodyRender: function (_a) {
            ...
            return (_J$X_(ResultBox["default"], { className: cx('TransferPicker', className, isOpened ? 'is-active' : ''), allowInput: false, result: value, onResultChange: onChange, onResultClick: onClick, placeholder: __('Select.placeholder'), disabled: disabled, borderMode: borderMode, itemRender: function (option) { return (_J$X_("span", null, (option && option[labelField]) || 'undefined')); }, mobileUI: mobileUI, maxTagCount: maxTagCount, overflowTagPopover: overflowTagPopover }, !mobileUI ? (_J$X_("span", { className: cx('TransferPicker-icon') },
