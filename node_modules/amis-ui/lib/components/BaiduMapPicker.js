...
var BaiduMapPicker = /** @class */ (function (_super) {
    ...
    BaiduMapPicker.prototype.componentDidMount = function () {
        if (window.BMap) {
            ...
            amisCore.loadScript("//api.map.baidu.com/api?v=3.0&ak=".concat(this.props.ak, "&callback={{callback}}")).then(this.initMap);
        }
    };
    ...
    BaiduMapPicker.prototype.render = function () {
        ...
        return (_J$X_("div", { className: cx('MapPicker') },
            ...
            _J$X_("div", { className: cx('MapPicker-result', {
                    invisible: hasSug
                }) },
            ...
            hasSug && !onlySelectCurrentLoc ? (_J$X_("div", { className: cx('MapPicker-sug') }, sugs.map(function (item) { return (_J$X_("div", { onClick: _this.handleSugSelect, className: cx('MapPicker-sugItem'), key: item }, item)); }))) : null));
    };
    tslib.__decorate([
        amisCore.autobind,
