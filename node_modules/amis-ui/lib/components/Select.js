...
var Select = /** @class */ (function (_super) {
    ...
    Select.prototype.renderValue = function (_a) {
                ...
                if (index === maxVisibleCount_1) {
                    return (_J$X_(TooltipWrapper["default"], { key: selection.length, container: popOverContainer, tooltip: tslib.__assign(tslib.__assign({}, tooltipProps_1), { children: function () { return (_J$X_("div", { className: cx('Select-overflow-wrapper') }, selection
                        ...
                        _J$X_("div", { className: cx('Select-value', {
                            ...
                            _J$X_("span", { className: cx('Select-valueLabel') }, renderValueLabel ? renderValueLabel(item) : item[labelKey]))));
                }
                return (_J$X_(TooltipWrapper["default"], { container: popOverContainer, placement: 'top', tooltip: item[labelKey], trigger: 'hover', key: index },
                    _J$X_("div", { className: cx('Select-value', {
                            'is-disabled': disabled,
                            'is-invalid': showInvalidMatch ? item.__unmatched : false
                        }) },
        ...
        return selection.map(function (item, index) {
            ...
            return valuesNoWrap ? ("".concat(item[labelKey]).concat(index === selection.length - 1 ? '' : ' + ')) : (_J$X_(TooltipWrapper["default"], { container: popOverContainer, placement: 'top', tooltip: item[labelKey], trigger: 'hover', key: index },
                _J$X_("div", { className: cx('Select-value', {
                        'is-disabled': disabled,
                        'is-invalid': showInvalidMatch ? item.__unmatched : false
                    }) },
        ...
        var renderItem = function (_a) {
            ...
            return (_J$X_("div", tslib.__assign({}, getItemProps({
                ...
                renderMenu ? (multiple ? (_J$X_(Checkbox["default"], { checked: checked, trueValue: item.value, onChange: function () {
                    ...
                    searchable: searchable,
                    index: index
                }))) : multiple ? (_J$X_("div", { title: item[labelField], className: cx('Select-option-checkbox') },
                    _J$X_(Checkbox["default"], { checked: checked, trueValue: item.value, onChange: function () {
                        ...
                        item.tip))) : (_J$X_("span", { className: cx('Select-option-content'), title: typeof item[labelField] === 'string' ? item[labelField] : '' },
                    item.disabled
                        ? item[labelField]
                        : amisCore.highlight(item[labelField], inputValue, cx('Select-option-hl')),
                    item.tip)),
    ...
    Select.prototype.render = function () {
        ...
        return (_J$X_(Downshift__default["default"], { selectedItem: selection, highlightedIndex: this.state.highlightedIndex, isOpen: this.state.isOpen, inputValue: inputValue, onChange: 
            ...
            multiple ? amisCore.noop : this.handleChange, onStateChange: this.handleStateChange, itemToString: function (item) { return (item ? "".concat(item[labelField]) : ''); } }, function (options) {
            var _a;
            var isOpen = options.isOpen;
            return (_J$X_("div", { tabIndex: disabled ? -1 : 0, onKeyPress: _this.handleKeyPress, onClick: _this.toggle, onFocus: _this.onFocus, onBlur: _this.onBlur, className: cx("Select", (_a = {},
                ...
                clearable &&
                    ...
                    (Array.isArray(value)
                        ? value.length
                        : value != null && value !== resetValue) ? (_J$X_("a", { onClick: _this.clearValue, className: cx('Select-clear') },
                ...
                _J$X_("span", { className: cx('Select-arrow') },
