...
var SparkLine = /** @class */ (function (_super) {
    ...
    SparkLine.prototype.render = function () {
        ...
        return (_J$X_("div", { className: cx('Sparkline', className, onClick ? 'Sparkline--clickable' : '', amisCore.setThemeClassName('baseControlClassName', id, themeCss), amisCore.setThemeClassName('wrapperCustomStyle', id, wrapperCustomStyle)), style: style, onClick: onClick }, Array.isArray(value) && value.length > 1 ? (_J$X_("svg", { className: cx('Sparkline-svg'), width: width, height: height, viewBox: "0 0 ".concat(width, " ").concat(height) }, this.renderLines())) : (placeholder !== null && placeholder !== void 0 ? placeholder : __('placeholder.empty'))));
    };
