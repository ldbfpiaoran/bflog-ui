...
var Pagination = /** @class */ (function (_super) {
    ...
    Pagination.prototype.renderEllipsis = function (key) {
        ...
        return (_J$X_("li", { key: key, className: cx('ellipsis') },
            _J$X_("a", { role: "button" }, "...")));
    };
    /**
     * 渲染器事件方法装饰器
    ...
    Pagination.prototype.render = function () {
        ...
        var go = (_J$X_("div", { className: cx('Pagination-inputGroup Pagination-item'), key: "go" },
            !mobileUI ? (_J$X_("span", { className: cx('Pagination-inputGroup-left'), key: "go-left" }, __('Pagination.goto'))) : null,
            _J$X_("input", { className: cx('Pagination-inputGroup-input'), key: "go-input", type: "text", disabled: disabled, onChange: this.handlePageChange, onFocus: function (e) { return e.currentTarget.select(); }, onKeyUp: function (e) {
            ...
            _J$X_("span", { className: cx('Pagination-inputGroup-right'), key: "go-right", onClick: function (e) {
                    if (!pageNum) {
                        return;
                    }
                    _this.setState({ pageNum: '' });
        ...
        var perPageEle = (_J$X_(Select["default"], { key: "perpage", className: cx('Pagination-perpage', 'Pagination-item'), clearable: false, disabled: disabled, value: perPage, options: selection, popOverContainer: popOverContainer, popOverContainerSelector: popOverContainerSelector, onChange: function (p) {
                _this.setState({
                    perPage: p.value,
                    pageNum: ''
                });
        ...
        return (_J$X_("div", { className: cx('Pagination-wrap', { disabled: disabled }, className) }, layoutList.map(function (layoutItem) {
