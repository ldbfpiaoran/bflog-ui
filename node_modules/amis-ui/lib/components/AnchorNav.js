...
var AnchorNavSectionComponent = /** @class */ (function (_super) {
    ...
    AnchorNavSectionComponent.prototype.render = function () {
        ...
        return (_J$X_("div", { ref: this.contentRef, className: cx('AnchorNav-section', className) }, children));
    };
...
var AnchorNav = /** @class */ (function (_super) {
    ...
    AnchorNav.prototype.renderLink = function (link, index) {
        ...
        return (_J$X_("li", { className: cx('AnchorNav-link', active === name ? 'is-active' : ''), key: index, onClick: function () { return _this.handleSelect(name); } },
