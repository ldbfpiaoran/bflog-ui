                ...
                isCollapsed ? null : (_J$X_("div", { className: cx('CBGroup-toolbar'), draggable: draggable, onDragStart: onDragStart },
                    _J$X_("div", { className: cx("CBGroup-toolbarConditionAdd".concat(builderMode === 'simple' ? '-simple' : '')) },
                        _J$X_("div", { className: cx('ButtonGroup') },
                            addConditionVisibleBool ? (_J$X_(Button["default"], { level: "link", onClick: this.handleAdd, size: "xs", disabled: disabled }, __('Condition.add_cond'))) : null,
                            addConditionGroupVisibleBool && builderMode !== 'simple' ? (_J$X_(Button["default"], { onClick: this.handleAddGroup, size: "xs", disabled: disabled, level: "link" }, __('Condition.add_cond_group'))) : null,
                            removeable ? (_J$X_(Button["default"], { onClick: onRemove, size: "xs", disabled: disabled, level: "link" }, __('Condition.delete_cond_group'))) : null)))))));
    };
    tslib.__decorate([
        amisCore.autobind,
