    ...
    DropDownSelection.prototype.render = function () {
        ...
        return (React__default.createElement(PopOverContainer, { mobileUI: mobileUI, popOverContainer: popOverContainer || (function () { return findDOMNode(_this); }), popOverRender: function (_a) {
                ...
                return (React__default.createElement("div", null,
                    ...
                    mode === 'list' ? (React__default.createElement(GroupedSelection, { multiple: false, onClick: function () { return _this.onPopClose(onClose); }, options: _this.filterOptions(_this.props.options), value: value, option2value: option2value, onChange: function (value) {
                            onChange(Array.isArray(value) ? value[0] : value);
                        } })) : (React__default.createElement(TreeSelection, { className: 'is-scrollable', multiple: false, options: _this.filterOptions(_this.props.options), value: value, loadingConfig: loadingConfig, onChange: function (value) {
            ...
            return (React__default.createElement("div", { className: cx('DropDownSelection') },
                React__default.createElement(ResultBox, { className: cx('DropDownSelection-input', isOpened ? 'is-active' : ''), ref: ref, allowInput: false, result: value
                        ...
                        : '', onResultChange: noop, onResultClick: onClick, placeholder: __('Condition.field_placeholder'), disabled: disabled, mobileUI: mobileUI }, !mobileUI ? (React__default.createElement("span", { className: cx('DropDownSelection-caret') },
