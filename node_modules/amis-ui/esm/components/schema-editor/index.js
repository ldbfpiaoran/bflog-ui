...
var SchemaEditor = /** @class */ (function (_super) {
    ...
    SchemaEditor.prototype.render = function () {
        ...
        return (React__default.createElement("div", { className: cx('SchemaEditor') },
...
var index = themeable(localeable(uncontrollable(SchemaEditor, {
    value: 'onChange'
})));

export { SchemaEditor, index as default };
