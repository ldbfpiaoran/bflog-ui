...
function InputTable(_a) {
    ...
    function renderBody() {
        ...
        return (React__default.createElement("div", { className: cx("Table", "InputTable-UI", className) },
            React__default.createElement("div", { className: cx("Table-contentWrap", { 'is-fixed': enableScroll }), style: { maxHeight: enableScroll ? scroll.y : 'unset' } },
                React__default.createElement("table", { className: cx("Table-table", tableClassName), ref: tableRef },
                    ...
                    React__default.createElement("tbody", { className: cx(tableBodyClassName) }, fields.length ? (fields.map(function (field, index) { return (React__default.createElement("tr", { key: field.id },
                        React__default.createElement(InputTableRow, { key: "columns", control: control, update: lightUpdate, index: index, value: field, columns: columns, translate: __, classnames: cx, formRef: subFormRef }),
...
var InputTableRow = React__default.memo(function InputTableRow(_a) {
    ...
    return (React__default.createElement(React__default.Fragment, null, columns.map(function (item, colIndex) { return (React__default.createElement("td", { key: colIndex, className: item.className }, item.tdRender(methods, colIndex, index))); })));
});
