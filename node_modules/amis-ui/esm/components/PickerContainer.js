    ...
    PickerContainer.prototype.render = function () {
        ...
        return (React__default.createElement(React__default.Fragment, null,
            ...
            React__default.createElement(ConfirmBox, { type: "dialog", size: size, closeOnEsc: closeOnEsc, show: this.state.isOpened, onCancel: this.close, title: title || __('Select.placeholder'), showTitle: showTitle, headerClassName: headerClassName, bodyClassName: bodyClassName, showFooter: showFooter, beforeConfirm: this.confirm, popOverContainer: popOverContainer, mobileUI: mobileUI, disabled: disabled }, function (_a) {
                ...
                return popOverRender(__assign(__assign({}, _this.state), { ref: _this.bodyRef, setState: _this.updateState, onClose: _this.close, onChange: _this.handleChange, onConfirm: _this.confirm, popOverContainer: popOverContainer, loading: loading }));
            })));
    };
    __decorate([
        autobind,
