...
var PopOverContainer = /** @class */ (function (_super) {
    ...
    PopOverContainer.prototype.render = function () {
        ...
        return (React__default.createElement(React__default.Fragment, null,
            ...
            mobileUI ? (React__default.createElement(PopUp, { isShow: this.state.isOpened, container: document.body, className: popOverClassName, showConfirm: showConfirm, onHide: this.close, onConfirm: this.onConfirm }, dropdownRender({ onClose: this.close }))) : (React__default.createElement(Overlay, { container: popOverContainer || this.getParent, target: this.getTarget, placement: placement || PopOverContainer.alignToPlacement({ align: align }), show: this.state.isOpened },
