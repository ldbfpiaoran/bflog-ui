                ...
                switch (_b.label) {
                    case 0:
                        ...
                        this.config = __assign(__assign({ inline: false, skin: false, content_css: false, height: 400, language: !locale || locale === 'zh-CN' ? 'zh_CN' : 'en', branding: false, plugins: [
                            ...
                            content_style: '[data-mce-bogus] video {display:none;}' }, rest), { target: this.elementRef.current, readOnly: this.props.disabled, promotion: false, setup: function (editor) {
                                _this.editor = editor;
