...
var Avatar = /** @class */ (function (_super) {
    ...
    Avatar.prototype.render = function () {
        ...
        return (React.createElement("span", { className: cx("Avatar", className, prefix + shape, sizeClass), style: __assign(__assign({}, sizeStyle), style), ref: this.avatarRef }, childrenRender));
    };
    Avatar.defaultProps = {
        shape: 'circle',
        size: 'default',
