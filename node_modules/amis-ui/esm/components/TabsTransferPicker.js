...
var TransferPicker = /** @class */ (function (_super) {
    ...
    TransferPicker.prototype.render = function () {
        ...
        return (React__default.createElement(PickerContainer, { title: __('Select.placeholder'), mobileUI: mobileUI, popOverContainer: popOverContainer, onFocus: this.onFoucs, onClose: this.onBlur, bodyRender: function (_a) {
