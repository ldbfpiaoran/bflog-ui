...
var AnchorNavSectionComponent = /** @class */ (function (_super) {
    ...
    AnchorNavSectionComponent.prototype.render = function () {
        ...
        return (React__default.createElement("div", { ref: this.contentRef, className: cx('AnchorNav-section', className) }, children));
    };
...
var AnchorNav = /** @class */ (function (_super) {
    ...
    AnchorNav.prototype.updateSectionOffset = function (parentNode, inited) {
        ...
        // 收集段落区域offsetTop
        children &&
            React__default.Children.forEach(children, function (section, index) {
                offsetArr.push({
    ...
    AnchorNav.prototype.scrollToSection = function (key) {
        // 获取指定段落的offsettop
        var offsetArr = this.state.offsetArr;
        var section = find(offsetArr, function (item) { return item.key === key; });
        var sectionRootDom = this.contentDom && this.contentDom.current;
        // 滚动到指定段落
        section &&
    ...
    AnchorNav.prototype.renderLink = function (link, index) {
        ...
        return (React__default.createElement("li", { className: cx('AnchorNav-link', active === name ? 'is-active' : ''), key: index, onClick: function () { return _this.handleSelect(name); } },
    ...
    AnchorNav.prototype.renderSection = function (section, index) {
        ...
        var active = activeProp === undefined && index === 0 ? name : activeProp;
        return React__default.cloneElement(section, __assign(__assign({}, section.props), { key: index, classnames: classnames, active: active }));
    };
