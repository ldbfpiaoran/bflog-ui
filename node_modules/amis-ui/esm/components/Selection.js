...
var BaseSelection = /** @class */ (function (_super) {
    ...
    BaseSelection.itemRender = function (option, states) {
        ...
        return (React__default.createElement("span", { title: title, className: "".concat(cx({ 'is-invalid': option === null || option === void 0 ? void 0 : option.__unmatched }), " ").concat(classnames('Selection-ellipsis-line')) },
            label,
            tip));
    };
