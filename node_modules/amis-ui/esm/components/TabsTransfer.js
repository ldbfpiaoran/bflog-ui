...
import { filter, createObject, autobind, themeable, localeable } from 'amis-core';
...
var TabsTransfer = /** @class */ (function (_super) {
    ...
    TabsTransfer.prototype.renderSearchResult = function (searchResult) {
        ...
        return mode === 'table' ? (React__default.createElement(TableCheckboxes, { placeholder: noResultsText, className: cx('Transfer-checkboxes'), columns: searchResultColumns, options: options, value: value, disabled: disabled, onChange: onChange, option2value: option2value, cellRender: cellRender, itemHeight: itemHeight, virtualThreshold: virtualThreshold })) : mode === 'tree' ? (React__default.createElement(Tree, { placeholder: noResultsText, className: cx('Transfer-checkboxes'), options: options, value: value, disabled: disabled, onChange: onChange, joinValues: false, onlyChildren: onlyChildren, showIcon: false, multiple: true, cascade: true, itemRender: optionItemRender
                ...
                : undefined, valueField: valueField, labelField: labelField })) : mode === 'chained' ? (React__default.createElement(ChainedCheckboxes, { placeholder: noResultsText, className: cx('Transfer-checkboxes'), options: options, value: value, disabled: disabled, onChange: onChange, option2value: option2value, itemRender: optionItemRender
                ? function (item, states) {
                    return optionItemRender(item, states, {
                        panel: 'result'
                    });
                }
                : undefined, itemHeight: itemHeight, virtualThreshold: virtualThreshold, valueField: valueField, labelField: labelField })) : (React__default.createElement(GroupedSelection, { placeholder: noResultsText, className: cx('Transfer-checkboxes'), options: options, value: value, disabled: disabled, onChange: onChange, option2value: option2value, itemRender: optionItemRender
                ? function (item, states) {
                    return optionItemRender(item, states, {
                        panel: 'result'
                    });
    ...
    TabsTransfer.prototype.renderSelect = function () {
        ...
        return (React__default.createElement(ThemedTabs, { mode: "line", className: cx('TabsTransfer-tabs'), onSelect: this.handleTabChange, activeKey: activeKey }, showOptions.map(function (option, index) { return (React__default.createElement(Tab, { eventKey: index, key: index, title: filter(option.label || option.title, createObject(ctx, option)), className: "TabsTransfer-tab" },
            option.searchable || searchable ? (React__default.createElement("div", { className: cx('TabsTransfer-search', { 'is-mobile': mobileUI }) },
    ...
    TabsTransfer.prototype.renderOptions = function (option) {
        ...
        return selectMode === 'table' ? (React__default.createElement(TableCheckboxes, { className: cx('Transfer-checkboxes'), columns: option.columns, options: option.children || [], value: value, multiple: multiple, disabled: disabled, onChange: onChange, option2value: option2value, onDeferLoad: onDeferLoad, cellRender: cellRender, itemHeight: itemHeight, virtualThreshold: virtualThreshold, valueField: valueField, labelField: labelField })) : selectMode === 'tree' ? (React__default.createElement(Tree, { loadingConfig: loadingConfig, className: cx('Transfer-checkboxes'), options: option.children || [], value: value, multiple: multiple, disabled: disabled, onChange: onChange, joinValues: false, showIcon: false, onlyChildren: (_a = option.onlyChildren) !== null && _a !== void 0 ? _a : onlyChildren, cascade: true, onDeferLoad: onDeferLoad, autoCheckChildren: option.autoCheckChildren, itemRender: optionItemRender
                ...
                : undefined, itemHeight: itemHeight, virtualThreshold: virtualThreshold, valueField: valueField, labelField: labelField })) : selectMode === 'chained' ? (React__default.createElement(ChainedCheckboxes, { className: cx('Transfer-checkboxes'), options: option.children || [], value: value, multiple: multiple, disabled: disabled, onChange: onChange, option2value: option2value, onDeferLoad: onDeferLoad, defaultSelectedIndex: option.defaultSelectedIndex, itemRender: optionItemRender
                ? function (item, states) {
                    return optionItemRender(item, states, {
                        panel: 'tab',
                        tag: option
                ...
                : undefined, itemHeight: itemHeight, virtualThreshold: virtualThreshold, valueField: valueField, labelField: labelField, deferField: deferField })) : (React__default.createElement(GroupedSelection, { className: cx('Transfer-checkboxes'), options: option.children || [], value: value, multiple: multiple, disabled: disabled, onChange: onChange, option2value: option2value, onDeferLoad: onDeferLoad, itemRender: optionItemRender
                ? function (item, states) {
                    return optionItemRender(item, states, {
                        panel: 'tab',
                        tag: option
    ...
    TabsTransfer.prototype.render = function () {
        var _a = this.props, className = _a.className, cx = _a.classnames; _a.optionItemRender; _a.onSearch; var mobileUI = _a.mobileUI, reset = __rest(_a, ["className", "classnames", "optionItemRender", "onSearch", "mobileUI"]);
        return (React__default.createElement(Transfer, __assign({}, reset, { mobileUI: mobileUI, statistics: false, classnames: cx, className: cx('TabsTransfer', className), selectRender: this.renderSelect })));
    };
