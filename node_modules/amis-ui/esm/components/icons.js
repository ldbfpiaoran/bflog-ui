...
function Icon(_a) {
    var _b;
    var icon = _a.icon, className = _a.className, _c = _a.classPrefix, classPrefix = _c === void 0 ? '' : _c, classNameProp = _a.classNameProp, iconContent = _a.iconContent, vendor = _a.vendor, iconCx = _a.cx, _d = _a.onClick, onClick = _d === void 0 ? function () { } : _d, style = _a.style;
    var cx$1 = iconCx || cx;
    ...
    if (React__default.isValidElement(icon)) {
        return React__default.cloneElement(icon, __assign(__assign({}, (icon.props || {})), { className: cx(cx$1(className, classNameProp), icon.props.className), style: style, onClick: onClick }));
    }
    if (iconContent) {
        // 从css变量中获取icon
        ...
        return (React__default.createElement("div", { onClick: onClick, className: cx$1(iconContent, className, classNameProp), ref: refFn, style: style }));
    }
    // 获取注册的icon
    var Component = getIcon(icon);
    if (Component) {
        return (React__default.createElement(Component, { onClick: onClick, className: cx$1(className, "icon-".concat(icon), classNameProp), 
            // @ts-ignore
    ...
    if (isObject(icon) &&
        ...
        if (!document.getElementById(id)) {
            ...
            return (React__default.createElement("svg", { onClick: onClick, className: cx$1('icon', 'icon-object', className, classNameProp), style: style },
    ...
    if (typeof icon === 'string' && icon.startsWith('<svg')) {
        ...
        var svgHTML = createElement('svg', {
            onClick: onClick,
            className: cx$1('icon', className, classNameProp),
            style: style,
    ...
    if (isURLIcon) {
        return (React__default.createElement("img", { onClick: onClick, className: cx$1("".concat(classPrefix, "Icon"), className, classNameProp), src: icon, style: style }));
    }
    // icon是普通字符串
    ...
    if (isIconfont) {
        return (React__default.createElement("i", { onClick: onClick, className: cx$1(icon, className, classNameProp, iconPrefix), style: style }));
    }
    // 没有合适的图标
...
export { Icon, closeIcon, enterIcon, getIcon, getIconNames, hasIcon, leftArrowIcon, muteIcon, pauseIcon, playIcon, reDoIcon, registerIcon, rightArrowIcon, unDoIcon, volumeIcon };
