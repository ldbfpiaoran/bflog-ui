...
var HeadCellSort = /** @class */ (function (_super) {
    ...
    HeadCellSort.prototype.render = function () {
        ...
        return (React__default.createElement("span", { className: cx('TableCell-sortBtn', 'aaa'), onClick: function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            React__default.createElement("i", { className: cx('TableCell-sortBtn--down', active && this.state.orderDir === 'desc' ? 'is-active' : '') },
                React__default.createElement(Icon, { icon: "sort-desc", className: "icon", iconContent: "table-sort-down" })),
            React__default.createElement("i", { className: cx('TableCell-sortBtn--up', active && this.state.orderDir === 'asc' ? 'is-active' : '') },
                React__default.createElement(Icon, { icon: "sort-asc", className: "icon", iconContent: "table-sort-up" })),
            React__default.createElement("i", { className: cx('TableCell-sortBtn--default', active ? '' : 'is-active') },
                React__default.createElement(Icon, { icon: "sort-default", className: "icon", iconContent: "table-sort-default" }))));
    };
    return HeadCellSort;
