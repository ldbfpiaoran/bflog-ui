...
var SummaryRow = /** @class */ (function (_super) {
    ...
    SummaryRow.prototype.render = function () {
        ...
        row === null || row === void 0 ? void 0 : row.forEach(function (s, index) {
            cells.push(React__default.createElement(BodyCell, { classnames: cx, classPrefix: classPrefix, key: 'summary-cell-' + index, fixed: s.fixed, colSpan: cells.length === 0
