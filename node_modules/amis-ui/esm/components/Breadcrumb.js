...
var Breadcrumb = /** @class */ (function (_super) {
    ...
    Breadcrumb.prototype.render = function () {
        ...
        var _a = this.props, className = _a.className, style = _a.style, separatorClassName = _a.separatorClassName, items = _a.items, separator = _a.separator, restProps = __rest(_a, ["className", "style", "separatorClassName", "items", "separator"]);
        ...
        var crumbs = items
            ...
            return (React__default.createElement(BreadcrumbItem, __assign({}, restProps, { item: item, itemPlace: itemPlace, key: index })));
        })
...
var BreadcrumbItem = /** @class */ (function (_super) {
    ...
    BreadcrumbItem.prototype.renderBreadcrumbBaseItem = function (showHref, itemType, item, label) {
        ...
        if (showHref) {
            return (React__default.createElement("a", { href: item.href, className: cx('Breadcrumb-item-' + itemType, baseItemClassName) },
                item.icon ? (React__default.createElement(Icon, { cx: cx, icon: item.icon, className: "Icon", classNameProp: "Breadcrumb-icon" })) : null,
                React__default.createElement("span", { className: cx('TplField') }, label)));
        }
        return (React__default.createElement("span", { className: cx('Breadcrumb-item-' + itemType, baseItemClassName) },
            item.icon ? (React__default.createElement(Icon, { cx: cx, icon: item.icon, className: "Icon", classNameProp: "Breadcrumb-icon" })) : null,
            React__default.createElement("span", { className: cx('TplField') }, label)));
    };
    /**
