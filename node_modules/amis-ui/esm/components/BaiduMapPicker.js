...
var BaiduMapPicker = /** @class */ (function (_super) {
    ...
    BaiduMapPicker.prototype.componentDidMount = function () {
        if (window.BMap) {
            ...
            loadScript("//api.map.baidu.com/api?v=3.0&ak=".concat(this.props.ak, "&callback={{callback}}")).then(this.initMap);
        }
    };
    ...
    BaiduMapPicker.prototype.initMap = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var autoSelectCurrentLoc, map, value, point, geolocationControl, input;
            var _this = this;
    ...
    BaiduMapPicker.prototype.render = function () {
        ...
        var _b = this.state, locIndex = _b.locIndex, locs = _b.locs, inputValue = _b.inputValue, sugs = _b.sugs;
        ...
        return (React__default.createElement("div", { className: cx('MapPicker') },
            ...
            React__default.createElement("div", { className: cx('MapPicker-result', {
                    invisible: hasSug
                }) },
            ...
            hasSug && !onlySelectCurrentLoc ? (React__default.createElement("div", { className: cx('MapPicker-sug') }, sugs.map(function (item) { return (React__default.createElement("div", { onClick: _this.handleSugSelect, className: cx('MapPicker-sugItem'), key: item }, item)); }))) : null));
    };
    __decorate([
        autobind,
