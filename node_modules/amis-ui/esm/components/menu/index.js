...
var Menu = /** @class */ (function (_super) {
    ...
    Menu.prototype.renderExpandIcon = function (ctx) {
        ...
        return (React__default.createElement("span", { key: "expand-toggle", className: cx('Nav-Menu-submenu-arrow'), onClick: function (e) {
                ...
                e.preventDefault();
            } }, !React__default.isValidElement(expandIcon) ? (React__default.createElement(Icon, { icon: typeof expandIcon === 'string' ? expandIcon : 'right-arrow-bold', className: "icon" })) : (expandIcon)));
    };
    Menu.prototype.renderMenuContent = function (list, level) {
        ...
        return list.map(function (item, index) {
            ...
            if ((link && link.defer && !link.loaded) ||
                ...
                return (React__default.createElement(SubMenu, __assign({}, item, { key: item.id, disabled: itemDisabled || link.loading, active: isActive(item), badge: badge, renderLink: renderLink, depth: level || 1, popupClassName: popupClassName }), _this.renderMenuContent(item.children || [], item.depth + 1)));
            }
