...
function editorFactory(dom, cm, props, options) {
    ...
    return cm(dom, __assign({ value: props.value || '', autofocus: true, mode: props.evalMode ? 'text/formula' : 'text/formula-template' }, options));
}
        ...
        var _loop_1 = function (line) {
            ...
            vars.forEach(function (v) {
                ...
                var _loop_2 = function () {
                    var encode = FormulaEditor.replaceStrByIndex(content, idx, v, REPLACE_KEY);
