...
var InputBox = /** @class */ (function (_super) {
    ...
    InputBox.prototype.render = function () {
        ...
        return (React__default.createElement("div", { className: cx('InputBox', className, (_a = {
                ...
                _a)), onClick: onClick },
            result,
            React__default.createElement(Input, __assign({}, rest, { value: value || '', onChange: this.handleChange, placeholder: placeholder, onFocus: this.handleFocus, onBlur: this.handleBlur, size: 12, disabled: disabled })),
            children,
