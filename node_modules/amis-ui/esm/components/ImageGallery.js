...
var ImageGallery = /** @class */ (function (_super) {
    ...
    ImageGallery.prototype.render = function () {
        ...
        return (React__default.createElement(React__default.Fragment, null,
            ...
            React__default.createElement(FinalModal, { closeOnEsc: true, closeOnOutside: true, size: "full", onHide: this.close, show: this.state.isOpened, contentClassName: cx('ImageGallery', imageGallaryClassName), container: modalContainer },
                ...
                items.length > 1 && enlargeWithGallary !== false ? (React__default.createElement("div", { className: cx('ImageGallery-footer') },
                    React__default.createElement("a", { className: cx('ImageGallery-prevList is-disabled') },
                        React__default.createElement(Icon, { icon: "prev", className: "icon" })),
                    React__default.createElement("div", { className: cx('ImageGallery-itemsWrap') },
