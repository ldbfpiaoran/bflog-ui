...
var SearchBox = /** @class */ (function (_super) {
    ...
    SearchBox.prototype.renderInput = function (isHistoryMode) {
        ...
        var enable = this.getHistoryOptions().enable;
        return (React__default.createElement("div", { className: cx('SearchBox', enhance && 'SearchBox--enhance', !!isHistoryMode ? '' : className, disabled ? 'is-disabled' : '', isFocused ? 'is-focused' : '', !mini || active ? 'is-active' : '', { 'is-history': enable }, { 'is-mobile': mobileUI }), style: style },
            React__default.createElement(Input, { name: name, ref: this.inputRef, disabled: disabled, placeholder: __(placeholder || 'placeholder.enter'), value: inputValue !== null && inputValue !== void 0 ? inputValue : '', autoComplete: "off", onFocus: this.handleFocus, onBlur: this.handleBlur, onChange: this.handleChange, onKeyDown: this.handleKeyDown }),
            !mini && clearable && inputValue && !disabled ? (React__default.createElement("div", { className: cx('SearchBox-clearable'), onClick: this.handleClear },
                React__default.createElement(Icon, { icon: "input-clear", className: "icon" }))) : null,
            !mini ? (React__default.createElement("a", { className: cx('SearchBox-searchBtn'), onClick: this.handleSearch },
                React__default.createElement(Icon, { icon: "search", className: "icon" }))) : active ? (React__default.createElement("a", { className: cx('SearchBox-cancelBtn'), onClick: this.handleCancel },
