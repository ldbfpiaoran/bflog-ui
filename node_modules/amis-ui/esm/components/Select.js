...
import { normalizeNodePath, isObject, findTree, getOptionValueBindField, getOptionValue, Overlay, PopOver, noop, ucFirst, autobind, themeable, localeable, uncontrollable, highlight } from 'amis-core';
...
var Select = /** @class */ (function (_super) {
    ...
    Select.prototype.renderValue = function (_a) {
        ...
        if (multiple &&
            ...
            var tooltipProps_1 = __assign({ placement: 'top', trigger: 'hover', showArrow: false, offset: [0, -10], tooltipClassName: cx('Select-overflow', overflowTagPopover === null || overflowTagPopover === void 0 ? void 0 : overflowTagPopover.tooltipClassName) }, omit(overflowTagPopover, ['children', 'content', 'tooltipClassName']));
            return __spreadArray(__spreadArray([], __read(selection.slice(0, maxVisibleCount_1)), false), [
                ...
                if (index === maxVisibleCount_1) {
                    return (React__default.createElement(TooltipWrapper, { key: selection.length, container: popOverContainer, tooltip: __assign(__assign({}, tooltipProps_1), { children: function () { return (React__default.createElement("div", { className: cx('Select-overflow-wrapper') }, selection
                        ...
                        React__default.createElement("div", { className: cx('Select-value', {
                            ...
                            React__default.createElement("span", { className: cx('Select-valueLabel') }, renderValueLabel ? renderValueLabel(item) : item[labelKey]))));
                }
                return (React__default.createElement(TooltipWrapper, { container: popOverContainer, placement: 'top', tooltip: item[labelKey], trigger: 'hover', key: index },
                    React__default.createElement("div", { className: cx('Select-value', {
                            'is-disabled': disabled,
                            'is-invalid': showInvalidMatch ? item.__unmatched : false
                        }) },
        ...
        return selection.map(function (item, index) {
            if (!multiple) {
                return (React__default.createElement("div", { className: cx('Select-value', {
                        'is-disabled': disabled,
                        'is-invalid': showInvalidMatch ? item.__unmatched : false
                    }), key: index }, renderValueLabel ? renderValueLabel(item) : item[labelKey]));
            }
            return valuesNoWrap ? ("".concat(item[labelKey]).concat(index === selection.length - 1 ? '' : ' + ')) : (React__default.createElement(TooltipWrapper, { container: popOverContainer, placement: 'top', tooltip: item[labelKey], trigger: 'hover', key: index },
                React__default.createElement("div", { className: cx('Select-value', {
                        'is-disabled': disabled,
                        'is-invalid': showInvalidMatch ? item.__unmatched : false
                    }) },
        ...
        var renderItem = function (_a) {
            ...
            return (React__default.createElement("div", __assign({}, getItemProps({
                ...
                renderMenu ? (multiple ? (React__default.createElement(Checkbox, { checked: checked, trueValue: item.value, onChange: function () {
                    ...
                    searchable: searchable,
                    index: index
                }))) : multiple ? (React__default.createElement("div", { title: item[labelField], className: cx('Select-option-checkbox') },
                    React__default.createElement(Checkbox, { checked: checked, trueValue: item.value, onChange: function () {
                        ...
                        item.tip))) : (React__default.createElement("span", { className: cx('Select-option-content'), title: typeof item[labelField] === 'string' ? item[labelField] : '' },
                    item.disabled
                        ? item[labelField]
                        : highlight(item[labelField], inputValue, cx('Select-option-hl')),
                    item.tip)),
