...
function ConfirmBox(_a) {
    ...
    function renderDialog() {
        return mobileUI ? (React__default.createElement(PopUp, { isShow: show, showConfirm: true, onConfirm: handleConfirm, onHide: onCancel, container: popOverContainer }, typeof children === 'function'
            ? children({
                bodyRef: bodyRef,
                loading: loading,
                popOverContainer: getPopOverContainer
            })
            : children)) : (React__default.createElement(FinalModal, { size: size, closeOnEsc: closeOnEsc, show: show, onHide: onCancel, container: popOverContainer, className: className },
            ...
            (showFooter !== null && showFooter !== void 0 ? showFooter : true) ? (React__default.createElement(FinalModal.Footer, { className: footerClassName },
                ...
                React__default.createElement(Button, { disabled: loading, onClick: onCancel }, __('cancel')),
                React__default.createElement(Button, { disabled: loading || disabled, onClick: handleConfirm, level: "primary" }, __('confirm')))) : null));
    }
