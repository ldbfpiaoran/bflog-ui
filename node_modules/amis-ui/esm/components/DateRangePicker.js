...
import { __extends, __spreadArray, __read, __assign, __rest } from 'tslib';
...
var DateRangePicker = /** @class */ (function (_super) {
    ...
    function DateRangePicker(props) {
        ...
        var _a = _this.props, format = _a.format, valueFormat = _a.valueFormat, joinValues = _a.joinValues, delimiter = _a.delimiter, value = _a.value, inputFormat = _a.inputFormat, displayFormat = _a.displayFormat, dateFormat = _a.dateFormat, timeFormat = _a.timeFormat;
        var _b = DateRangePicker.unFormatValue(value, valueFormat || format, joinValues, delimiter), startDate = _b.startDate, endDate = _b.endDate;
    ...
    DateRangePicker.prototype.componentDidUpdate = function (prevProps) {
        ...
        var value = props.value, format = props.format, valueFormat = props.valueFormat, joinValues = props.joinValues, inputFormat = props.inputFormat, displayFormat = props.displayFormat, dateFormat = props.dateFormat, timeFormat = props.timeFormat, delimiter = props.delimiter;
        ...
        if (prevProps.value !== value) {
            var _a = DateRangePicker.unFormatValue(value, valueFormat || format, joinValues, delimiter), startDate = _a.startDate, endDate = _a.endDate;
            this.setState({
                startDate: startDate,
                endDate: endDate,
    ...
    DateRangePicker.prototype.close = function (isConfirm) {
        ...
        if (!isConfirm) {
            ...
            var _a = this.props, value = _a.value, format = _a.format, valueFormat = _a.valueFormat, joinValues = _a.joinValues, delimiter = _a.delimiter, inputFormat = _a.inputFormat, displayFormat = _a.displayFormat;
            var _b = DateRangePicker.unFormatValue(value, valueFormat || format, joinValues, delimiter), startDate = _b.startDate, endDate = _b.endDate;
            this.setState({
                startDate: startDate,
                endDate: endDate,
    ...
    DateRangePicker.prototype.renderShortcuts = function (shortcuts) {
        ...
        var _a = this.props, ns = _a.classPrefix, format = _a.format, valueFormat = _a.valueFormat, data = _a.data;
        var shortcutArr;
    ...
    DateRangePicker.prototype.reset = function () {
        var _a = this.props, resetValue = _a.resetValue, onChange = _a.onChange, format = _a.format, valueFormat = _a.valueFormat, joinValues = _a.joinValues, delimiter = _a.delimiter, inputFormat = _a.inputFormat, displayFormat = _a.displayFormat;
        if (!resetValue) {
            return;
        }
        var _b = DateRangePicker.unFormatValue(resetValue, valueFormat || format, joinValues, delimiter), startDate = _b.startDate, endDate = _b.endDate;
        onChange(resetValue);
        this.setState({
            startInputValue: startDate === null || startDate === void 0 ? void 0 : startDate.format(displayFormat || inputFormat),
            endInputValue: endDate === null || endDate === void 0 ? void 0 : endDate.format(displayFormat || inputFormat)
    ...
    DateRangePicker.prototype.renderDay = function (props, currentDate) {
        ...
        var _b = this.getDisabledElementProps(currentDate, 'day'), className = _b.className, others = __rest(_b, ["className"]);
    ...
    DateRangePicker.prototype.renderMonth = function (props, month, year, date) {
        ...
        var _b = this.getDisabledElementProps(currentDate, 'month'), className = _b.className, others = __rest(_b, ["className"]);
        props.className += className;
    ...
    DateRangePicker.prototype.renderCalendar = function () {
        var _this = this;
        var _a = this.props, ns = _a.classPrefix, cx = _a.classnames, inputFormat = _a.inputFormat, displayFormat = _a.displayFormat, ranges = _a.ranges, shortcuts = _a.shortcuts, locale = _a.locale, embed = _a.embed, type = _a.type, _b = _a.viewMode, viewMode = _b === void 0 ? 'days' : _b, label = _a.label, mobileUI = _a.mobileUI;
        var __ = this.props.translate;
        ...
        return (React__default.createElement("div", { className: cx("".concat(ns, "DateRangePicker-wrap"), { 'is-mobile': mobileUI }), ref: this.calendarRef },
            ...
            React__default.createElement("div", { className: cx("".concat(ns, "DateRangePicker-picker-wrap"), {
                ...
                (!isTimeRange ||
                    ...
                    // isEndDate
                    isValidDate: this.checkEndIsValidDate, viewMode: viewMode, input: false, onClose: this.close, renderDay: this.renderDay, renderMonth: this.renderMonth, renderQuarter: this.renderQuarter, renderYear: this.renderYear, locale: locale, timeRangeHeader: "\u7ED3\u675F\u65F6\u95F4", embed: embed }))),
    ...
    DateRangePicker.prototype.render = function () {
        var _a;
        var _this = this;
        var _b = this.props, className = _b.className, popoverClassName = _b.popoverClassName, ns = _b.classPrefix, cx = _b.classnames, value = _b.value, startPlaceholder = _b.startPlaceholder, endPlaceholder = _b.endPlaceholder, popOverContainer = _b.popOverContainer, inputFormat = _b.inputFormat, displayFormat = _b.displayFormat; _b.joinValues; _b.delimiter; var clearable = _b.clearable, disabled = _b.disabled, embed = _b.embed, overlayPlacement = _b.overlayPlacement, borderMode = _b.borderMode, mobileUI = _b.mobileUI; _b.timeFormat; var minDate = _b.minDate, maxDate = _b.maxDate, minDuration = _b.minDuration, maxDuration = _b.maxDuration; _b.dateFormat; var _c = _b.viewMode, viewMode = _c === void 0 ? 'days' : _c, ranges = _b.ranges, shortcuts = _b.shortcuts, label = _b.label, animation = _b.animation;
        ...
        var __ = this.props.translate;
        var calendarMobile = (React__default.createElement(CalendarMobile, { timeFormat: curTimeFormat, displayForamt: displayFormat || inputFormat, startDate: startDate, endDate: endDate, minDate: minDate, maxDate: maxDate, minDuration: minDuration, maxDuration: maxDuration, dateFormat: curDateFormat, embed: embed, viewMode: viewMode, close: this.close, confirm: this.confirm, onChange: this.handleMobileChange, footerExtra: this.renderShortcuts(ranges || shortcuts), showViewMode: viewMode === 'quarters' || viewMode === 'months' ? 'years' : 'months' }));
        if (embed) {
        ...
        return (React__default.createElement("div", { tabIndex: 0, onKeyPress: this.handleKeyPress, onFocus: this.handleFocus, onBlur: this.handleBlur, className: cx("".concat(ns, "DateRangePicker"), (_a = {
            ...
            React__default.createElement(Input, { className: cx('DateRangePicker-input', {
                ...
                }), onChange: this.startInputChange, onClick: this.openStart, ref: this.startInputRef, placeholder: __(startPlaceholder), autoComplete: "off", value: this.state.startInputValue || '', disabled: disabled, readOnly: mobileUI }),
            ...
            React__default.createElement(Input, { className: cx('DateRangePicker-input', {
                ...
                }), onChange: this.endInputChange, onClick: this.openEnd, ref: this.endInputRef, placeholder: __(endPlaceholder), autoComplete: "off", value: this.state.endInputValue || '', disabled: disabled, readOnly: mobileUI }),
            ...
            isOpened ? (mobileUI ? (React__default.createElement(PopUp, { isShow: isOpened, container: popOverContainer, className: cx("".concat(ns, "CalendarMobile-pop"), "".concat(ns, "CalendarMobile-pop--").concat(viewMode)), onHide: this.close, header: CalendarMobileTitle, showClose: false }, useCalendarMobile ? calendarMobile : this.renderCalendar())) : (React__default.createElement(Overlay, { target: function () { return _this.dom.current; }, onHide: this.close, container: popOverContainer || (function () { return findDOMNode(_this); }), rootClose: false, placement: overlayPlacement, show: true },
