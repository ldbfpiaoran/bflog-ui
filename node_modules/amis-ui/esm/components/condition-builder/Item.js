...
var ConditionItem = /** @class */ (function (_super) {
    ...
    ConditionItem.prototype.handleLeftChange = function (leftValue) {
        ...
        var value = __assign(__assign({}, this.props.value), { left: leftValue, op: (field === null || field === void 0 ? void 0 : field.defaultOp) || ((_a = config.types[field === null || field === void 0 ? void 0 : field.type]) === null || _a === void 0 ? void 0 : _a.defaultOp) || undefined, right: undefined });
        var onChange = this.props.onChange;
        onChange(value, this.props.index);
    };
    ConditionItem.prototype.handleOperatorChange = function (op) {
        ...
        var result = __assign(__assign({}, value), { op: op, right: (_a = value.right) !== null && _a !== void 0 ? _a : leftFieldSchema === null || leftFieldSchema === void 0 ? void 0 : leftFieldSchema.defaultValue });
    ...
    ConditionItem.prototype.renderOperator = function () {
        var _this = this;
        var _a, _b;
        var _c = this.props, funcs = _c.funcs, config = _c.config, fields = _c.fields, value = _c.value, cx = _c.classnames, disabled = _c.disabled, popOverContainer = _c.popOverContainer, mobileUI = _c.mobileUI;
        ...
        if (Array.isArray(operators) && operators.length) {
            ...
            return (React__default.createElement(PopOverContainer, { mobileUI: mobileUI, popOverContainer: popOverContainer || (function () { return findDOMNode(_this); }), popOverRender: function (_a) {
                    var onClose = _a.onClose;
                    return (React__default.createElement(GroupedSelection, { onClick: onClose, option2value: option2value, onChange: _this.handleOperatorChange, options: options_1, value: value.op, multiple: false }));
                } }, function (_a) {
                var _b;
                ...
                return (React__default.createElement("div", { className: cx('CBGroup-operator') },
                    React__default.createElement(ResultBox, { className: cx('CBGroup-operatorInput', isOpened ? 'is-active' : ''), ref: ref, allowInput: false, result: __1(OperationMap[value === null || value === void 0 ? void 0 : value.op]) ||
                            ((_b = options_1.find(function (option) { return option.value === value.op; })) === null || _b === void 0 ? void 0 : _b.label), onResultChange: noop, onResultClick: onClick, disabled: disabled, placeholder: __1('Condition.cond_placeholder'), mobileUI: mobileUI }, !mobileUI ? (React__default.createElement("span", { className: cx('CBGroup-operatorCaret') },
    ...
    ConditionItem.prototype.renderRightWidgets = function (type, op) {
        ...
        if (op === 'is_empty' || op === 'is_not_empty') {
            ...
            return (React__default.createElement(React__default.Fragment, null,
                React__default.createElement(Expression, { config: config, funcs: funcs, valueField: field, value: (_c = value.right) === null || _c === void 0 ? void 0 : _c[0], data: data, onChange: this.handleRightSubChange.bind(this, 0), fields: fields, allowedTypes: (field === null || field === void 0 ? void 0 : field.valueTypes) ||
                ...
                React__default.createElement(Expression, { config: config, funcs: funcs, valueField: field, value: (_d = value.right) === null || _d === void 0 ? void 0 : _d[1], data: data, onChange: this.handleRightSubChange.bind(this, 1), fields: fields, allowedTypes: (field === null || field === void 0 ? void 0 : field.valueTypes) ||
                        config.valueTypes || ['value', 'field', 'func'], disabled: disabled, formula: formula, popOverContainer: popOverContainer, renderEtrValue: renderEtrValue })));
        }
