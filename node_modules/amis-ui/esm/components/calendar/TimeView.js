...
var CustomTimeView = /** @class */ (function (_super) {
    ...
    CustomTimeView.prototype.render = function () {
        ...
        var quickLists = [
            React__default.createElement("a", { key: "select-now", onClick: this.selectNowTime }, __('TimeNow'))
        ];
        return (React__default.createElement(React__default.Fragment, null,
            ...
            this.props.requiredConfirm && (React__default.createElement("div", { className: cx('TimeFooterWrapper') },
                ...
                React__default.createElement("a", { className: cx('Button', 'Button--primary', 'Button--size-sm'), onClick: this.confirm }, __('confirm'))))));
    };
