...
import CustomCalendarContainer from './CalendarContainer.js';
import cx from 'classnames';
import moment from 'moment';
import { utils, convertArrayValueToMoment, themeable } from 'amis-core';
...
var BaseDatePicker = /** @class */ (function (_super) {
    ...
    function BaseDatePicker(props) {
        ...
        _this.onConfirm = function (value, types) {
            var currentDate = (_this.state.selectedDate ||
                ...
                moment()).clone();
            var date = convertArrayValueToMoment(value, types, currentDate);
    ...
    BaseDatePicker.prototype.render = function () {
        ...
        var Component = CustomCalendarContainer;
        ...
        return (React__default.createElement("div", { className: cx('rdt rdtStatic rdtOpen', this.props.className, (timeFormat && !dateFormat) || typeof dateFormat !== 'string'
                ? 'rdtTimeWithoutD'
                : timeFormat && timeFormat.toLowerCase().indexOf('s') > 0
                    ...
                    : timeFormat
                        ? 'rdtTime'
                        : '') },
            React__default.createElement("div", { key: "dt", className: cx('rdtPicker', {
                    ...
                    : timeFormat && dateFormat
                        ...
                        : dateFormat && !timeFormat
                            ? 'rdtPickerDate'
                            : '') },
                React__default.createElement(Component, { view: this.state.currentView, viewProps: viewProps, timeRangeHeader: timeRangeHeader }))));
    };
    return BaseDatePicker;
}(React__default.Component));
var Calendar = themeable(BaseDatePicker);
