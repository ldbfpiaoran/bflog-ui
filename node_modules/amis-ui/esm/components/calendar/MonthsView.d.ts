...
export interface CustomMonthsViewProps extends LocaleProps {
    ...
    renderMonth?: (props: any, month: number, year: number, date: any) => React.ReactNode;
...
export declare class CustomMonthsView extends React.Component<CustomMonthsViewProps> {
    ...
    renderMonth: (props: any, month: number, year: number, date: moment.Moment) => React.JSX.Element;
    onConfirm: (value: number[], types?: string[]) => void;
