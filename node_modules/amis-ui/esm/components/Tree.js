...
import { __extends, __assign, __spreadArray, __read, __values, __decorate, __metadata } from 'tslib';
import React__default from 'react';
import { eachTree, getTreeAncestors, flattenTree, flattenTreeWithLeafNodes, getTreeParent, findTreeIndex, isVisible, highlight, hasAbility, autobind, themeable, localeable } from 'amis-core';
import { value2array } from './Select.js';
import { Icon, getIcon } from './icons.js';
...
var TreeSelector = /** @class */ (function (_super) {
            ...
            if (autoCheckChildren) {
                ...
                if (onlyChildren) {
                    ...
                    while (true) {
                        ...
                        if ((parent_1 === null || parent_1 === void 0 ? void 0 : parent_1.value) && !value.has(parent_1)) {
    ...
    TreeSelector.prototype.renderInput = function (prfix) {
        ...
        return (React__default.createElement("div", { className: cx('Tree-itemLabel', {
            ...
            React__default.createElement("div", { className: cx('Tree-itemInput', {
                ...
                prfix,
                React__default.createElement("input", { onChange: this.handleInputChange, value: inputValue, placeholder: __('placeholder.enter') }),
                React__default.createElement("a", { "data-tooltip": __('cancel'), onClick: this.handleCancel },
                    React__default.createElement(Icon, { icon: "close", className: "icon" })),
                React__default.createElement("a", { "data-tooltip": __('confirm'), onClick: this.handleConfirm },
    ...
    TreeSelector.prototype.renderItem = function (_a) {
        ...
        var checkbox = multiple ? (React__default.createElement(Checkbox, { size: "sm", disabled: disabled, checked: checked || partial, partial: partial, onChange: this.handleCheck.bind(this, item, !checked) })) : showRadio ? (React__default.createElement(Checkbox, { size: "sm", disabled: disabled, checked: checked, onChange: this.handleSelect.bind(this, item) })) : null;
        ...
        if (isEditing && editingItem === item) {
            ...
            body = this.renderInput(React__default.createElement("span", { className: cx('Tree-itemArrowPlaceholder') }));
        }
        else {
            body = (React__default.createElement("div", { className: cx('Tree-itemLabel', {
                ...
                draggable && (React__default.createElement("a", { className: cx('Tree-itemDrager drag-bar') },
                    React__default.createElement(Icon, { icon: "drag-bar", className: "icon" }))),
                item.loading ? (React__default.createElement(Spinner, { size: "sm", show: true, icon: "reload", spinnerClassName: cx('Tree-spinner'), loadingConfig: loadingConfig })) : !isLeaf || (item[deferField] && !item.loaded) ? (React__default.createElement("div", { onClick: function () { return _this.toggleUnfolded(item); }, className: cx('Tree-itemArrow', {
                ...
                checkbox,
                React__default.createElement("div", { className: cx('Tree-itemLabel-item', { 'is-mobile': mobileUI }) },
                    showIcon ? (React__default.createElement("i", { className: cx("Tree-itemIcon ".concat(Array.isArray(item.children) && item.children.length
                            ? 'Tree-folderIcon'
                            : 'Tree-leafIcon')), onClick: function () {
                            return !disabled &&
                                (multiple
                                    ? _this.handleCheck(item, !checked)
                                    : _this.handleSelect(item));
                        } }, iconValue ? (getIcon(iconValue) ? (React__default.createElement(Icon, { icon: iconValue, className: "icon" })) : React__default.isValidElement(iconValue) ? (iconValue) : (React__default.createElement("i", { className: iconValue }))) : null)) : null,
                    React__default.createElement("span", { className: cx('Tree-itemText'), onClick: function () {
                            return !disabled &&
                                (multiple
                                    ? _this.handleCheck(item, !checked)
                                    : _this.handleSelect(item));
                    ...
                    !disabled &&
                        !isAdding &&
                        !isEditing &&
                        !(item[deferField] && !item.loaded) ? (React__default.createElement("div", { className: cx('Tree-item-icons') },
                        creatable && hasAbility(item, 'creatable') ? (React__default.createElement(TooltipWrapper, { placement: 'bottom', tooltip: __(createTip), trigger: 'hover', tooltipTheme: "dark" },
                            React__default.createElement("a", { onClick: this.handleAdd.bind(this, item) },
                        ...
                        removable && hasAbility(item, 'removable') ? (React__default.createElement(TooltipWrapper, { placement: 'bottom', tooltip: __(removeTip), trigger: 'hover', tooltipTheme: "dark" },
                            React__default.createElement("a", { onClick: this.handleRemove.bind(this, item) },
                        ...
                        editable && hasAbility(item, 'editable') ? (React__default.createElement(TooltipWrapper, { placement: 'bottom', tooltip: __(editTip), trigger: 'hover', tooltipTheme: "dark" },
                            React__default.createElement("a", { onClick: this.handleEdit.bind(this, item) },
                                React__default.createElement(Icon, { icon: "new-edit", className: "icon" })))) : null)) : null)));
        }
        return (React__default.createElement("li", { key: "".concat(item[valueField || 'value'], "-").concat(index), className: cx("Tree-item ".concat(itemClassName || ''), {
                'Tree-item--isLeaf': isLeaf,
                'is-child': this.relations.get(item)
            }), style: __assign(__assign({}, style), { paddingLeft: "calc(".concat(level, " * var(--Tree-indent))") }) }, body));
    };
    ...
    TreeSelector.prototype.renderList = function (list, value) {
        ...
        if (virtualThreshold && list.length > virtualThreshold) {
            return (React__default.createElement(VirtualList, { height: list.length > 8 ? 266 : list.length * itemHeight, itemCount: list.length, prefix: this.renderCheckAll(), itemSize: itemHeight, 
    ...
    TreeSelector.prototype.render = function () {
        ...
        if (creatable && rootCreatable !== false && hideRoot) {
            addBtn = (React__default.createElement("a", { className: cx('Tree-addTopBtn', {
        ...
        return (React__default.createElement("div", { className: cx("Tree ".concat(className || ''), {
            ...
            (flattenedOptions && flattenedOptions.length) ||
                ...
                this.renderList(flattenedOptions, value))) : (React__default.createElement("li", { className: cx('Tree-rootItem', {
                    'is-checked': !value || !value.length
                }) },
                React__default.createElement("div", { className: cx('Tree-itemLabel') },
                    React__default.createElement("span", { className: cx('Tree-itemText'), onClick: this.clearSelect },
                    ...
                    !disabled &&
                        ...
                        rootCreatable !== false &&
                        !isAdding &&
                        !isEditing ? (React__default.createElement("div", { className: cx('Tree-item-icons') }, creatable ? (React__default.createElement("a", { onClick: this.handleAdd.bind(this, null), "data-tooltip": rootCreateTip, "data-position": "left" },
                ...
                React__default.createElement("ul", { className: cx('Tree-sublist') },
                    isAdding && !addingParent ? (React__default.createElement("li", { className: cx('Tree-item') }, this.renderInput())) : null,
                    this.renderList(flattenedOptions, value)))))) : (React__default.createElement("div", { className: cx('Tree-placeholder') }, placeholder)),
