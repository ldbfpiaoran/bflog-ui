...
var DatePicker = /** @class */ (function (_super) {
    ...
    DatePicker.prototype.render = function () {
        ...
        return (React__default.createElement("div", { tabIndex: 0, onKeyPress: this.handleKeyPress, onFocus: this.handleFocus, onBlur: this.handleBlur, className: cx("DatePicker", (_a = {
            ...
            React__default.createElement(Input, { className: cx('DatePicker-input'), onChange: this.inputChange, onBlur: this.onInputBlur, ref: this.inputRef, placeholder: placeholder, autoComplete: "off", value: this.state.inputValue || '', disabled: disabled, readOnly: mobileUI }),
            clearable &&
                !disabled &&
                normalizeDate(value, valueFormat || format) ? (React__default.createElement("a", { className: cx("DatePicker-clear"), onClick: this.clearValue },
