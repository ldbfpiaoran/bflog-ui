...
import { removeHTMLTag, decodeEntity, filter, isEffectiveApi, getImageDimensions, toDataURL, getVariable, createObject, isPureVariable, resolveVariableAndFilter, arraySlice, flattenTree, TableStore } from 'amis-core';
        ...
        return __generator(this, function (_q) {
            switch (_q.label) {
                ...
                case 6:
                    ...
                    filteredColumns_1 = (e_6 = void 0, __values(filteredColumns)), filteredColumns_1_1 = filteredColumns_1.next();
                    _q.label = 7;
                case 7:
                ...
                case 14:
                    ...
                    sourceValue = source;
                    if (!isPureVariable(source)) return [3 /*break*/, 15];
                    map = resolveVariableAndFilter(source, rowData, '| raw');
                    return [3 /*break*/, 18];
                case 15:
                    if (!isEffectiveApi(source, data)) return [3 /*break*/, 18];
