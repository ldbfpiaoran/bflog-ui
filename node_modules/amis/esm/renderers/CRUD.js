...
var CRUD = /** @class */ (function (_super) {
    ...
    CRUD.prototype.componentDidUpdate = function (prevProps) {
        ...
        if (prevProps.syncLocation &&
            ...
            store.updateQuery(parseQuery(props.location, { parsePrimitive: props.parsePrimitiveQuery }), undefined, props.pageField, props.perPageField);
