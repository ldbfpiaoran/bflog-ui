...
var CRUD2 = /** @class */ (function (_super) {
    ...
    CRUD2.prototype.componentDidUpdate = function (prevProps) {
        ...
        if (prevProps.syncLocation &&
            ...
            store.updateQuery(amisCore.parseQuery(props.location, { parsePrimitive: parsePrimitiveQuery }), undefined, props.pageField, props.perPageField);
    ...
    CRUD2.prototype.handleSearch = function (data) {
        ...
        if (parsePrimitiveQuery) {
            query = amisCore.parsePrimitiveQueryString(query);
        }
