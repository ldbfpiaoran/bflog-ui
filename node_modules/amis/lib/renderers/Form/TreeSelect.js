...
var TreeSelectControl = /** @class */ (function (_super) {
    ...
    TreeSelectControl.prototype.handleFocus = function (e) {
        ...
        dispatchEvent('focus', amisCore.resolveEventData(this.props, { value: value }));
    };
    TreeSelectControl.prototype.handleBlur = function (e) {
        var _a = this.props, dispatchEvent = _a.dispatchEvent, value = _a.value; _a.data;
        dispatchEvent('blur', amisCore.resolveEventData(this.props, { value: value }));
    };
            ...
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        filteredOptions = !amisCore.isEffectiveApi(autoComplete) && searchable && this.state.inputValue
