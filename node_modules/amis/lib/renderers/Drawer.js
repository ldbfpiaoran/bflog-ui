...
var Drawer = /** @class */ (function (_super) {
    ...
    Drawer.prototype.renderFooter = function () {
        ...
        return (_J$X_("div", { className: cx('Drawer-footer', footerClassName, amisCore.setThemeClassName('drawerFooterClassName', id, themeCss)) },
    ...
    Drawer.prototype.render = function () {
        ...
        return (_J$X_(Container, tslib.__assign({}, rest, { resizable: resizable, classPrefix: ns, className: className, style: style, drawerClassName: amisCore.setThemeClassName('drawerClassName', id, themeCss), drawerMaskClassName: amisCore.setThemeClassName('drawerMaskClassName', id, themeCss), size: size, onHide: this.handleSelfClose, disabled: store.loading, show: show, showCloseButton: showCloseButton, width: width, height: height, position: position, overlay: overlay, onEntered: this.handleEntered, onExited: this.handleExited, closeOnEsc: closeOnEsc, closeOnOutside: !store.drawerOpen && !store.dialogOpen && closeOnOutside, container: drawerContainer ? drawerContainer : env === null || env === void 0 ? void 0 : env.getModalContainer }),
            _J$X_("div", { className: cx('Drawer-header', headerClassName, amisCore.setThemeClassName('drawerHeaderClassName', id, themeCss)) },
                title ? (_J$X_("div", { className: cx('Drawer-title', amisCore.setThemeClassName('drawerTitleClassName', id, themeCss)) }, render('title', title, {
                    data: store.formData,
                ...
                header
                    ...
                    : null),
            !store.entered ? (_J$X_("div", { className: cx('Drawer-body', bodyClassName, amisCore.setThemeClassName('drawerBodyClassName', id, themeCss)) },
                _J$X_(amisUi.Spinner, { overlay: true, show: true, size: "lg", loadingConfig: loadingConfig }))) : body ? (
            // dialog-body 用于在 editor 中定位元素
            _J$X_("div", { className: cx('Drawer-body', bodyClassName, amisCore.setThemeClassName('drawerBodyClassName', id, themeCss)), role: "dialog-body" },
...
window.amisVersionInfo={version:'3.6.3',buildTime:'2023-12-06'};
