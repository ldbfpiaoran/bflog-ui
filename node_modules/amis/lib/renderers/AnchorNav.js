...
var AnchorNav = /** @class */ (function (_super) {
    ...
    AnchorNav.prototype.render = function () {
        ...
        children = links
            ...
            return amisCore.isVisible(section, data) ? (_J$X_(amisUi.AnchorNavSection, tslib.__assign({}, section, { title: amisCore.filter(section.title, data), key: index, name: section.href || index }), _this.renderSection
