...
var Cards = /** @class */ (function (_super) {
    ...
    Cards.prototype.renderFooter = function () {
        ...
        var toolbarNode = actions || child ? (_J$X_("div", { className: cx('Cards-toolbar'), key: "footer-toolbar" },
            actions,
            child)) : null;
        var footerNode = footer ? (_J$X_("div", { className: cx('Cards-footer', footerClassName), key: "footer" }, render('footer', footer))) : null;
    ...
    Cards.prototype.render = function () {
        ...
        return (_J$X_("div", { ref: this.bodyRef, className: cx('Cards', className, {
            ...
            }, amisCore.setThemeClassName('baseControlClassName', id, themeCss), amisCore.setThemeClassName('wrapperCustomStyle', id, wrapperCustomStyle)), style: amisCore.buildStyle(style, data) },
