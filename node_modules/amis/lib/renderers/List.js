...
var List = /** @class */ (function (_super) {
    ...
    List.prototype.renderFooter = function () {
        ...
        var toolbarNode = actions || child ? (_J$X_("div", { className: cx('List-toolbar', footerClassName), key: "footer-toolbar" },
            actions,
            child)) : null;
        var footerNode = footer && (!Array.isArray(footer) || footer.length) ? (_J$X_("div", { className: cx('List-footer', footerClassName), key: "footer" }, render('footer', footer))) : null;
