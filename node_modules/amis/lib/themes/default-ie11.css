...
.cxd-Collapse--title-bottom.is-active .cxd-Collapse-arrow {
  top: 0;
...
.cxd-CollapseGroup .cxd-Collapse:last-child {
  border-radius: 0 0 4px 4px;
}
.cxd-CollapseGroup .cxd-Collapse:last-child > .cxd-Collapse-header {
  border-radius: 0 0 4px 4px;
}
...
.cxd-Checkbox.cxd-Checkbox--checkbox.cxd-Checkbox--button > i + span {
  margin-left: 0;
}
.cxd-Checkbox > i {
  cursor: pointer;
...
.cxd-Checkbox--checkbox:hover {
  color: #151b26;
}
.cxd-Checkbox--checkbox:active {
  color: #151b26;
}
...
.cxd-Checkbox--checkbox input:checked + i:hover {
  border-width: 1px 1px 1px 1px;
  border-style: solid solid solid solid;
  border-color: #2468f2 #2468f2 #2468f2 #2468f2;
  border-radius: 0.125rem 0.125rem 0.125rem 0.125rem;
...
.cxd-Checkbox--checkbox.cxd-Checkbox:active > i:before {
  background: #144bcc;
}
.cxd-Checkbox--full.cxd-Checkbox--checkbox:not(:disabled) + i:hover {
  border-color: #e8e9eb;
}
.cxd-Checkbox--full.cxd-Checkbox--checkbox:hover input:checked + i {
  background: #528eff;
  border-color: transparent;
}
...
.cxd-Checkbox--button.cxd-Checkbox--checkbox:hover:not(:disabled):first-child {
  box-shadow: none;
}
...
.cxd-Checkbox--button.cxd-Checkbox--checkbox:active input:checked + i {
  background: transparent;
...
.cxd-Checkbox--button--checked.cxd-Checkbox--checkbox.cxd-Checkbox--button {
  border-color: #2468f2;
  color: #2468f2;
  box-shadow: -1px 0 0 0 #2468f2;
}
.cxd-Checkbox--button--checked.cxd-Checkbox--checkbox.cxd-Checkbox--button:first-child {
  box-shadow: none;
}
.cxd-Checkbox--button--checked.cxd-Checkbox--checkbox.cxd-Checkbox--button:hover {
  border-color: #2468f2;
  color: #2468f2;
  box-shadow: -1px 0 0 0 #2468f2;
}
.cxd-Checkbox--button--checked.cxd-Checkbox--checkbox.cxd-Checkbox--button:active {
  border-color: #144bcc;
  color: #144bcc;
...
.cxd-Checkbox--button--disabled--unchecked.cxd-Checkbox--checkbox:hover:first-child {
  box-shadow: none !important;
}
...
.cxd-Checkbox--radio:hover input:not(:disabled) + i + span {
  color: #070c14;
}
.cxd-Checkbox--radio.cxd-Checkbox--button--disabled--unchecked.cxd-Checkbox--full {
  background: none;
}
.cxd-Checkbox--radio.cxd-Checkbox--button--disabled--unchecked.cxd-Checkbox--full i {
  background: #f7f8fa;
  border: 1px solid #e8e9eb;
}
.cxd-Checkbox--radio.cxd-Checkbox--button--disabled--unchecked.cxd-Checkbox--full i:before {
  background: #d4d6d9;
}
.cxd-Checkbox--sm {
...
.cxd-RadiosControl .cxd-Checkbox--button--disabled--unchecked {
  background: #f7f8fa;
}
.cxd-RadiosControl .cxd-Checkbox--button-checked:active {
  border-color: #144bcc;
}
...
.cxd-CheckboxesControl .cxd-Checkbox--button--disabled--unchecked {
  background: #f7f8fa;
}
.cxd-CheckboxesControl .cxd-Checkbox--button-checked:active {
  border-color: #144bcc;
}
...
.cxd-Select-option-checkbox > label {
  width: 100%;
  display: flex;
  text-overflow: ellipsis;
  overflow: hidden;
...
.cxd-Select-option-checkbox > label > i {
  flex-shrink: 0;
}
.cxd-Select-option-checkbox > label > span {
  text-overflow: ellipsis;
  overflow: hidden;
  white-space: nowrap;
  width: 100%;
...
.cxd-SelectControl .cxd-TransferDropDown-popover {
  border: none;
}
...
.cxd-Combo-addBtn.cxd-Button--iconOnly {
  min-width: 1.625rem;
  padding: 0;
}
.cxd-Combo-addBtn.cxd-Button--iconOnly:not(.cxd-Button--link) > svg.icon {
  width: 0.875rem;
  height: 0.875rem;
}
.cxd-Combo-addBtn.cxd-Button--iconOnly:not(.cxd-Button--link) > .fa,
.cxd-Combo-addBtn.cxd-Button--iconOnly:not(.cxd-Button--link) > .iconfont {
  font-size: 0.875rem;
}
.cxd-Combo-addBtn.cxd-Button--iconOnly:not(.cxd-Button--link) > .iconfont {
  line-height: 1;
...
.cxd-Combo-addBtn:disabled, .cxd-Combo-addBtn.is-disabled {
  color: #b8babf;
  background: #f7f8fa;
  border-color: #f7f8fa #f7f8fa #f7f8fa #f7f8fa;
  border-width: 1px 1px 1px 1px;
...
.cxd-IconSelectControl-input-icon-show {
  width: 1.25rem;
  height: 1.25rem;
  margin-right: 0.25rem;
}
...
.cxd-Form--column-2 > .cxd-Form-item:nth-last-child(2) {
  margin-bottom: 0;
}
